...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: UilSrcSrc.c /main/cde1_maint/1 1995/07/14 20:57:07 drk $"
#endif
#endif
...
/* %COMPLETE */
externaldef(uil_comp_glbl) off_t Uil_file_size;
struct stat stbuf;
...

{
    ...
    */
    ...
    if (((unsigned) az_src_rec->b_file_number == 
	 src_az_current_source_buffer->b_file_number)
	 &&
