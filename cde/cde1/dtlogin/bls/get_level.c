/* $XConsortium: get_level.c /main/cde1_maint/2 1995/10/23 09:29:14 gtsang $ */
/*
 * get_level.c 
 * last modified by: 
...
int
#ifdef _NO_PROTO
verify_user_seclevel(verify, desired_label)
...
int
#ifdef _NO_PROTO
verify_sec_xterm(verify, desired_label)
struct verify_info *verify;
char *desired_label;
#else
...
int
#ifdef _NO_PROTO
writeLoginInfo( filename, verify)
char *filename;
struct verify_info *verify;
#else
