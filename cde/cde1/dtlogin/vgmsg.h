/* $XConsortium: vgmsg.h /main/cde1_maint/4 1995/10/09 00:14:36 pascale $ */
/*                                                                      *
...
#if 0
  typedef int  nl_catd;		/* message catalog stuff...		   */
  extern int catclose();
  extern char *catgets();
...
extern nl_catd	nl_fd;		/* message catalog file descriptor	   */
...
#ifdef __apollo
#  define DEF_NLS_CATALOG	"/usr/nlslib/C/dtlogin.cat"
#endif

#ifdef __hp_osf
#  define DEF_NLS_CATALOG	"/usr/lib/nls/msg/en_US.88591/dtlogin.cat"
#endif

#ifdef __osf__
#  define DEF_NLS_CATALOG     "/usr/lib/nls/msg/en_US.ISO8859-1/dtlogin.cat"
#endif
  
#ifdef __hpux
#  if OSMAJORVERSION <= 8 && OSMINORVERSION < 3
#    define DEF_NLS_CATALOG	"/usr/dt/nls/C/dtlogin.cat"
#  endif
#endif

#ifndef DEF_NLS_CATALOG
#  define DEF_NLS_CATALOG     CDE_INSTALLATION_TOP "/lib/nls/msg/C/dtlogin.cat"
#endif
...
#define MC_REMOTE_LABEL		75
#define MC_REMOTE_HOST_LABEL    76
#define MC_RET_LOGIN_LABEL      77
#define MC_LOGIN_SCREEN_LABEL   78
#define MC_CHOOSE_HOST_LABEL    79
#define MC_REMOTE_HOST          80
...
#define MC_NOT_CONSOLE		73
#define MC_BAD_SHELL		74
#define MC_ETC_SHELLS		75
...
#define MC_BAD_HOSTNAME	        75
#define MC_HOST_NOT_RUN_LOGIN   76
#define MC_CONNECT_TO_HOST      77

#define MC_CHOOSER_SET          5
#define MC_CHOOSER_TITLE        1
#define MC_CHOOSER_HEADING      2
#define MC_UPDATE_LABEL         3
#define MC_HOST_UNKNOWN_LABEL	20
#define MC_CHOOSER_RS_LABEL	21
...
#define MC_DEF_RET_LOGIN_LABEL	"Return to Local Host"
#define MC_DEF_LOGIN_SCREEN_LABEL  "Return to Login Screen"
#define MC_DEF_NW_LABEL		"Command Line Login"
#define MC_DEF_REMOTE_LABEL	"Remote Login"
#define MC_DEF_REMOTE_HOST_LABEL	"Enter Host Name ..."
#define MC_DEF_CHOOSE_HOST_LABEL	"Choose Host From List ..."
...
#define MC_DEF_NOT_CONSOLE	"Not on system console, root login rejected."
#define MC_DEF_BAD_SHELL	"Invalid user shell, login rejected."
#define MC_DEF_ETC_SHELLS	"User shell not listed in /etc/shells.\n\
				 Login rejected."
...
\n\
   ...
   Session - to select a graphical environment\n\
     OpenWindows Desktop - for OW \n\
     Common Desktop Environment - for CDE \n\
   ...
   Reset Login Screen - restarts the X-server and Login Screen\n\
\n\
...
"
#define MC_DEF_REMOTE_HOST \
"\n\
Enter the host name for remote desktop login:      \n\
"	   
/*
...
\n\
   Language - to change the session language\n\
   Reset Chooser Screen - resets X-server and restarts Chooser\n\
\n\
Click anywhere on the background with any mouse button to\n\
refresh the screen, for example, if system messages make the\n\
screen unreadable.\n\
...
#define MC_DEF_SUS2_LABEL	"* If currently logged out, press [Enter] for a console login prompt.\r\n*\r\n"
#define MC_DEF_SUS3_LABEL	"* Desktop Login will resume shortly after you exit console session.\r\n*\r\n"
...
#define MC_DEF_CHOOSER_TITLE  "Select a remote host to log into:"
#define MC_DEF_CHOOSER_HEADING        "Host Name                      Host Information"
#define MC_DEF_CHOOSER_RS_LABEL	"Reset Chooser Screen"
#define MC_DEF_UPDATE_LABEL   " Update List "
#define MC_DEF_HOST_UNKNOWN_LABEL "{ unknown }"
#define MC_DEF_HOST_NOT_RUN_LOGIN   \
"Remote host could not be accessed. The remote \n\
host name is valid, but the remote host may not \n\
be running dtlogin (or other X display manager)."
#define MC_DEF_BAD_HOSTNAME  \
	"Remote host name is unknown: please try again."
#define MC_DEF_CONNECT_TO_HOST  \
