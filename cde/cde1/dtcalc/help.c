/* $XConsortium: help.c /main/cde1_maint/3 1995/10/10 09:20:30 rcs $ */
/*                                                                      *
 *  help.c                                                              *
...
#else /* AIX_ILS */
  label = XmStringCreateLtoR(errString, XmFONTLIST_DEFAULT_TAG) ;
#endif /* AIX_ILS */
...
#else /* AIX_ILS */
    ok = XmStringCreateLtoR(GETMESSAGE(4, 4, "OK"), XmFONTLIST_DEFAULT_TAG);
#endif /* AIX_ILS */
