/*
static char rcsid[] =
  "$XConsortium: SrvFile_io.c /main/cde1_maint/2 1995/08/30 16:37:59 gtsang $";
*/
/*                                                                      *
...
#endif /* _NO_PROTO */
{
    ...
    /* Look for palette in system location */
...
#endif /* _NO_PROTO */
{
   ...
   if(colorSrv.TypeOfMonitor[screen_num] != B_W)
...
*/
         ...
         if(colorSrv.FgColor[screen_num] != DYNAMIC)
	 {
      ...
      if(colorSrv.TypeOfMonitor[screen_num] == LOW_COLOR || 
                            colorSrv.TypeOfMonitor[screen_num] == MEDIUM_COLOR)
