/*
 *	$XConsortium: abuil_load.c /main/cde1_maint/3 1995/10/16 14:46:25 rcs $
 *
...
)
{
	...
	*p_res_type = AB_ARG_STRING;
	...
	if (XmStringGetLtoR((XmString)resource_value->value.c_value,
			    XmFONTLIST_DEFAULT_TAG, (char **)&ret_val))
	{
	    *p_res_type = AB_ARG_STRING;
	}
	else
	    ret_val = (XtPointer)NULL;
	break;
