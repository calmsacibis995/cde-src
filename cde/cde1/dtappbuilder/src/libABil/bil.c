...
/*
 * $XConsortium: bil.c /main/cde1_maint/3 1995/10/16 14:48:13 rcs $
 * 
...
#define off ((int)BIL_TOKEN_MIN_VALUE)	/* offset to 1st token */
    ...
    btt[AB_BIL_C_HEADER_FILE_EXTENSION - off] = istr_const(":c-header-file-extension");
    btt[AB_BIL_C_IMPL_FILE_EXTENSION - off] = istr_const(":c-impl-file-extension");
    ...
    btt[AB_BIL_WRITE_MAIN_FUNC - off] = istr_const(":write-main-func");
