...
/*
 *	$XConsortium: brws.c /main/cde1_maint/3 1995/10/16 13:36:28 rcs $
 *
...
)
{
	...
	if (util_get_verbosity() > 0)
	{
	    ...
	    if (obj->ui_handle)
	    {
	        ...
	        util_dprintf(1, 
			"Ui handle - %x, Widget name: %s, class: %s\n", 
...
)
{
	...
	/*
	 * Save pointer to instance structures so that we
	 * can free them later
	 */
