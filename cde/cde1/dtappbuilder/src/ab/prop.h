...
/*
 *	$XConsortium: prop.h /main/cde1_maint/3 1995/10/16 11:06:02 rcs $
 *
...
typedef struct _PROP_COMOBOX_SETTING {
    Widget	label;
    Widget	field;
    Widget	changebar;
} PropComboboxSettingRec, *PropComboboxSetting;
...
extern STRING	prop_colorfield_get_value(
		    PropColorSetting	pcs
                ...
                /* Combobox Setting Functions
                 */
extern void     prop_combobox_init(
                    PropComboboxSetting pcs,
                    Widget              label,
                    Widget              combobox,
                    Widget              changebar
                );
extern STRING   prop_combobox_get_value(
                    PropComboboxSetting pcs
                );
extern int      prop_combobox_set_value(
                    PropComboboxSetting pcs,
                    STRING	        value,
                    BOOL                trip_changebar
                );
...
extern int	prop_options_get_value(
		    PropOptionsSetting  pos
		);
