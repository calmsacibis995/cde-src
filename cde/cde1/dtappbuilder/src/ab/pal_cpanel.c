...
/*
 *      $XConsortium: pal_cpanel.c /main/cde1_maint/2 1995/10/16 13:49:58 rcs $
 *
...
)
{
    ...
    /* Clear Border Frame */
    prop_options_set_value(&(pcs->frame), AB_LINE_NONE, False);
...
)
{
    ...
    {
	/* Load Border Frame */
	prop_options_set_value(&(pcs->frame), obj_get_border_frame(obj), False);
