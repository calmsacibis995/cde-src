/*
 *      $XConsortium: pal_mainwin.c /main/cde1_maint/3 1995/10/16 13:53:23 rcs $
 *
...
)
{
    ...
    /* Clear Resize Mode */
    prop_radiobox_set_value(&(pms->resize_mode), (int)True, False);
    ...
    /* Clear Size Policy */
    prop_radiobox_set_value(&(pms->size_policy), SIZE_FIXED_KEY, False);
...
)
{
	...
	/* Load Resize Mode */
	prop_radiobox_set_value(&(pms->resize_mode), obj_get_resizable(obj), False);
