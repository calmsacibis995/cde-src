...
/*
 *	$XConsortium: brws_utils.c /main/cde1_maint/3 1995/10/16 13:38:09 rcs $
 *
...
)
{
    ...
    /*
    fprintf(stderr, "brwsP_node_is_collapsed(%s), viewer = %x\n", 
	obj_get_name(obj),
	node->browser);
    */
...
)
{
    ...
    obj = (AB_OBJ *)node->obj_data;
    /*
    fprintf(stderr, "brwsP_node_is_visible(%s), viewer = %x\n", 
	obj_get_name(obj),
	node->browser);
    */
