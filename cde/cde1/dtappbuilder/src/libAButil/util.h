...
/*
 *	$XConsortium: util.h /main/cde1_maint/7 1995/10/23 12:30:15 rcs $
 *
...
int	util_fclose(FILE *fp);		/* sets fp to NULL */
...
int	util_ftruncate(FILE *file, off_t length);       /* truncate open file*/
int	util_flock(
			FILE    *file,
			BOOL    wait, 
			int     lockType, 
