...
/*
 *	$XConsortium: istr_hash.c /main/cde1_maint/2 1995/10/16 17:05:32 rcs $
 *
 * @(#)istr_hash.c	1.5 01/20/96
 *
...
delete(HASH *hashtable, ISTRING istring)
{
    ...
    if(istring == 0)  
    {
        fprintf(stderr,"the reference string %d doesn't exist\n",
            istring);
        return 0;
    }
    val = hashing(istring);
