...
/*
 *      $XConsortium: lib_func_strings.c /main/cde1_maint/3 1995/10/16 14:24:41 rcs $
 *
...
/*
 * abmfP_lib_drag_button2_event_handler
 */
static LibFuncRec abmfP_lrc_drag_button2_event_handler = 
{
    /* name */
    ...
    "    }\n"
    "}"
}; /* abmfP_lrc_drag_button2_event_handler */
LibFunc abmfP_lib_drag_button2_event_handler = &(abmfP_lrc_drag_button2_event_handler);
...
static LibFuncRec abmfP_lrc_default_dragCB = 
{
    ...
    /* def */
    "/*\n"
    " * This callback may be called multiple times during one drag operation.\n"
    " * At a minimum, the developer must add code to the DTB_DND_CONVERT case \n"
    " * below; all of the other cases are optional.\n"
    " *\n"
    " * Each time this function is called, the request parameter and one data \n"
    " * structure parameter are used to handle the \"request,\" and the other \n"
    " * parameters will be NULL. At the top of each case statement, \n"
    " * the data structure used in that case is explained.\n"
    " * \n"
    " */\n"
    "void \n"
    "dtb_default_dragCB(\n"
    ...
    "        /** DTB_USER_CODE_START \n"
    "	 ** \n"
    "	 ** Uses local variable: dragStart\n"
    "	 **\n"
    "	 ** The drag will start normally, using the defaults for this\n"
    "	 ** drag site (as configured in the application builder), and one \n"
    "	 ** item to transfer assumed.\n"
    "	 **\n"
    "	 ** To override the default protocol, operations, cursor, or \n"
    "	 ** number of of items to transfer, add code after this comment\n"
    "	 ** and modify the contents of the dragStart variable. For\n"
    "	 ** example, to provide two files:\n"
    "	 **\n"
    "	 ** 	dragStart->numItems = 2;\n"
    "	 **	dragStart->protocol = DtDND_FILENAME_TRANSFER;\n"
    "	 **\n"
    "	 **     The actual file names would need to be provided in\n"
    "	 **     the DTB_DND_CONVERT case, below.\n"
    "	 **/\n"
    "        printf(\"action: dtb_default_dragCB(DTB_DND_DRAG_START)\\n\");\n"
    "        /*** DTB_USER_CODE_END   ^^^ Add C code above ^^^ ***/\n"
    "	break; /* DTB_DND_DRAG_START */\n"
    "\n"
    "	/****************************************************************/\n"
    "\n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: convert\n"
    "	 **\n"
    "	 ** Here, the data must be supplied to the dropped-on object.\n"
    "	 ** Look at the convert->dragData->protocol and \n"
    "	 ** convert->dragData->numItems fields to determine the how many\n"
    "	 ** data items and the proper type to supply.\n"
    "	 **\n"
    "	 ** The data being returned must be set in convert->dragData->data,\n"
    "	 ** as illustrated in the following code. The code following\n"
    "	 ** this comment should be modified to provide the data that\n"
    "	 ** this application is sourcing.\n"
    "	 **/\n"
    "\n"
    "        printf(\"action: dtb_default_dragCB(DTB_DND_CONVERT)\\n\");\n"
    "	switch (convert->dragData->protocol)\n"
    "	{\n"
    "	    case DtDND_BUFFER_TRANSFER:\n"
    "	        convert->dragData->data.buffers = NULL;\n"
    "	    break;\n"
    "    \n"
    "	    case DtDND_FILENAME_TRANSFER:\n"
    "            {\n"
    "                char *thisFilename = \"/etc/passwd\";\n"
    "                if ((convert->dragData->data.files = \n"
    "                        (String *)malloc(sizeof(String))) != NULL);\n"
    "                {\n"
    "                    if ((convert->dragData->data.files[0] = \n"
    "                        (String)malloc(strlen(thisFilename))) != NULL)\n"
    "                    {\n"
    "                        strcpy(convert->dragData->data.files[0], thisFilename);\n"
    "                    }\n"
    "                }\n"
    "            }\n"
    "	    break;\n"
    ...
    "                if ((convert->dragData->data.strings = \n"
    "                        (XmString*)malloc(sizeof(XmString))) != NULL)\n"
    "                {\n"
    "                    convert->dragData->data.strings[0] = \n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: deleteSource\n"
    "	 **\n"
    "	 ** A move has been completed, and the source object(s) must\n"
    "	 ** be deleted. Look at deleteSource->dragData->numItems and \n"
    "	 ** deleteSource->dragData->data to determine what source items\n"
    "	 ** should be deleted. Note that \"delete\" means delete the \n"
    "	 ** objects that were dragged (e.g., actually remove dragged \n"
    "	 ** files), not the C++ definition of \"delete.\"\n"
    "	 **\n"
    "	 ** The code after this comment should be modified to actually\n"
    "	 ** delete the dragged objects. \n"
    "	 **/\n"
    "\n"
    "        printf(\"action: dtb_default_dragCB(DTB_DND_DELETE)\\n\");\n"
    "	for (i = 0; i < deleteSource->dragData->numItems; ++i)\n"
    "	{\n"
    "	    switch (deleteSource->dragData->protocol)\n"
    "	    {\n"
    "	    case DtDND_BUFFER_TRANSFER:\n"
    "		/* delete deleteSource->dragData->data.buffers[i] */\n"
    "	    break;\n"
    "\n"
    "	    case DtDND_FILENAME_TRANSFER:\n"
    "		/* delete deleteSource->dragData->data.filenames[i] */\n"
    "	    break;\n"
    "\n"
    "	    case DtDND_TEXT_TRANSFER:\n"
    "		/* delete deleteSource->dragData->data.strings[i] */\n"
    "	    break;\n"
    "	    } /* SWitch(protocol) */\n"
    "	} /* for i */\n"
    "\n"
    "        /*** DTB_USER_CODE_END   ^^^ Add C code above ^^^ ***/\n"
    "	break; /* DTB_DND_DELETE */\n"
    "\n"
    "	/****************************************************************/\n"
    "\n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: dropOnRootWindow\n"
    "	 **\n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: finish\n"
    "	 **\n"
    "	 ** The drag and drop operation has completed (successfully or\n"
    "	 ** unsuccessfully). Clean up and allocated memory or other\n"
    "	 ** resources allocated during this drag (i.e., memory allocated\n"
    "	 ** in the DTB_DND_CONVERT case).\n"
    "	 **/\n"
    "        printf(\"action: dtb_default_dragCB(DTB_DND_FINISH)\\n\");\n"
    "	for (i = 0; i < finish->dragData->numItems; ++i)\n"
    "	{\n"
    "	    switch (finish->dragData->protocol)\n"
    "	    {\n"
    "	    case DtDND_BUFFER_TRANSFER:\n"
    "		/* free finish->dragData->data.buffers[i] */\n"
    "	    break;\n"
    "\n"
    "	    case DtDND_FILENAME_TRANSFER:\n"
    "		/* free finish->dragData->data.filenames[i] */\n"
    "	    break;\n"
    "\n"
    "	    case DtDND_TEXT_TRANSFER:\n"
    "		/* free finish->dragData->data.strings[i] */\n"
    "	    break;\n"
    "	    }\n"
    "	} /* for i */\n"
    "        /*** DTB_USER_CODE_END   ^^^ Add C code above ^^^ ***/\n"
...
static LibFuncRec abmfP_lrc_default_dropCB = 
{
    ...
    /* def */
    "/*\n"
    " * This callback may be called multiple times during one drop operation.\n"
    " * At a minimum, the developer must add code to the DTB_DND_RECEIVE_DATA\n"
    " * case below; all of the other cases are optional (e.g., changing the\n"
    " * default registration parameters or performing drop site animation).\n"
    " *\n"
    " * Each time this function is called, the widget and request parameters\n"
    " * are valid, and one data structure parameter is used to handle the \n"
    " * \"request,\" The other parameters should be ignored. At the top of \n"
    " * each case statement, the data structure used in that case is made clear.\n"
    " * \n"
    ...
    "        /** DTB_USER_CODE_START \n"
    "	 **\n"
    "	 ** Uses local variable: registerInfo\n"
    "	 **\n"
    ...
    "	 **\n"
    "	 ** For example, to change the available drop operations:\n"
    "	 **\n"
    "	 **	receiveInfo->operations = XmDROP_COPY|XmDROP_MOVE;\n"
    "	 **/\n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: receiveInfo\n"
    "	 **\n"
    ...
    "	 **\n"
    "	 ** Modify the code after this comment to process the data\n"
    "	 ** as needed by this application.\n"
    "	 **/\n"
    "\n"
    "        printf(\"action: dtb_default_dropCB(DTB_DND_RECEIVE_DATA)\\n\");\n"
    "	for (i = 0; i < receiveInfo->dropData->numItems; ++i)\n"
    "	{\n"
    "	    switch (receiveInfo->dropData->protocol)\n"
    "	    {\n"
    "	    case DtDND_BUFFER_TRANSFER:\n"
    "	        /* get data from convert->dragData->data.buffers[i] */\n"
    "	    break;\n"
    "       \n"
    "            case DtDND_FILENAME_TRANSFER:\n"
    "	        /* get filename from convert->dragData->data.files[i] */\n"
    "            break;\n"
    "       \n"
    "            case DtDND_TEXT_TRANSFER:\n"
    "	        /* get XmString from convert->dragData->data.strings[i] */\n"
    "	    break;\n"
    "	    } /* switch protocol */\n"
    "        } /* for i */\n"
    "\n"
    ...
    "        /** DTB_USER_CODE_START\n"
    "	 **\n"
    "	 ** Uses local variable: animateInfo\n"
    "	 **\n"
    "	 ** Provide visual feedback on the acceptability of the provided\n"
    "	 ** data (for instance, look at animateInfo->dropData->protocol\n"
    "	 ** and animateInfo->dropData->data).\n"
    "	 **/\n"
