...
/*
 * $XConsortium: make_file.c /main/cde1_maint/8 1995/11/07 11:23:30 rcs $
 * 
...
"###########################################################################\n",
	osName);
     ...
     abio_puts(makeFile,
"        RM = rm -f\n"
"        INCLUDES = -I/usr/dt/include -I/usr/include/X11\n"
"\n"
...
"###########################################################################\n",
	osName);
     ...
     abio_puts(makeFile,
"        RM = rm -f\n"
"        INCLUDES = -I/usr/dt/include -I/usr/X/include\n"
"\n"
"        STD_DEFINES = \n"
"        ANSI_DEFINES = \n"
"\n"
...
)
{
    ...
    *modName = 0;
    ...
    {
	strcpy(projFlag, "-changed -merge -noproject");
    }
    else
    {
