...
/*
 *	$XConsortium: write_c.c /main/cde1_maint/4 1995/10/16 14:31:59 rcs $
 *
...
/*
 * writes #include fileName
 * Absolutely no processing is done on the string fileName
 */
int
