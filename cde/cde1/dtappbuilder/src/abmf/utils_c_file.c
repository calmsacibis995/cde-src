...
/*
 *	$XConsortium: utils_c_file.c /main/cde1_maint/3 1995/10/16 14:31:15 rcs $
 *
...
write_all_static_func_decls(GenCodeInfo genCodeInfo, ABObj project)
{
    ...
    abio_printf(codeFile, "%s\n\n", abmfP_lib_drag_button2_event_handler->proto);
...
write_all_lib_funcs(GenCodeInfo genCodeInfo, ABObj project)
{
    ...
    write_lib_func(genCodeInfo, abmfP_lib_drag_button2_event_handler);
