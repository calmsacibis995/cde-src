...
/*
 *	$XConsortium: proj_header_file.c /main/cde1_maint/2 1995/10/16 14:28:38 rcs $
 *
...
)
{
    ...
    {
	/* we're not writing main(), so write a declaration for the init
	 * func to use instead.
	 */
        abmfP_write_c_comment(genCodeInfo, 
	    FALSE, 
   "Project initialization function, to be called from user-defined main()");
