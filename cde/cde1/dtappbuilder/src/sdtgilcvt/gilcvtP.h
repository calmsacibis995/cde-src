 ...
 *	$Revision: 1.1 $
 *
 *	@(#)gilcvtP.h	1.3 06/22/95	cde_app_builder/src/dtgilcvt
 *
 ...
 *
 */
#pragma ident "@(#)gilcvtP.h	1.3 95/06/22 SMI"

/*
 * gilcvtP.h - declarations common to all gilcvt files
 */

#ifndef _GILCVT_GILCVTP_H_
#define _GILCVT_GILCVTP_H_
