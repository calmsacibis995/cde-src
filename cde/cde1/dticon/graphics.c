/* $XConsortium: graphics.c /main/cde1_maint/4 1995/10/09 14:25:22 pascale $ */
/*********************************************************************
...
void
#ifdef _NO_PROTO
Circle_Box( win, x1, y1, x2, y2, box )
        Window win ;
        int x1 ;
        int y1 ;
        int x2 ;
...
static void
#ifdef _NO_PROTO
Do_HotBox( client_data, local_id )
