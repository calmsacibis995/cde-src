/* $XConsortium: process.c /main/cde1_maint/3 1995/10/09 14:26:07 pascale $ */
/********************************************************************
...
#ifdef _NO_PROTO
static void Do_DropCheckOp();
static void Do_DropOp();
#else
...
#endif /* _NO_PROTO */
{
 ...
 return (strdup(strchr(objects, '/')));
    ...
    /* allocate space for "/nfs/<host>/<path>" */
    fullName = XtMalloc (strlen(host)+strlen(path)+6);
    strcpy (fullName, "/nfs/");
