/* $XConsortium: help.c /main/cde1_maint/2 1995/10/23 08:57:06 gtsang $ */
/*********************************************************************
...
void
#ifdef _NO_PROTO
HelpTriggerCB( w, client_data, call_data )
        Widget w ;
        caddr_t client_data ;
        caddr_t call_data ;
#else
...
void
#ifdef _NO_PROTO
HelpOnItemCB( w, client_data, call_data )
        Widget w ;
        caddr_t client_data ;
        caddr_t call_data ;
#else
...
void
#ifdef _NO_PROTO
HelpHyperlinkCB( w, client_data_unused, call_data )
        Widget w ;
...
void
#ifdef _NO_PROTO
HelpCloseCB( w, client_data, call_data_unused )
        Widget w ;
        caddr_t client_data ;
...
void
#ifdef _NO_PROTO
DisplayNewHelp(helpVolume, locationId)
        char *helpVolume;
        char *locationId;
#else
DisplayNewHelp(
