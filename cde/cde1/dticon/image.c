/* $XConsortium: image.c /main/cde1_maint/4 1995/10/23 08:58:24 gtsang $ */
/*********************************************************************
...
int
#ifdef _NO_PROTO
Block_Rotate( src_image, dst_image, rtype )
        XImage *src_image ;
        XImage *dst_image ;
        int rtype ;
#else
...
int
#ifdef _NO_PROTO
Flood_Fill( color_image, mono_image, x, y, width, height, new_pixel, new_mono )
        XImage *color_image ;
        XImage *mono_image ;
        int x ;
        int y ;
