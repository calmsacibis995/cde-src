/* $XConsortium: event.c /main/cde1_maint/5 1995/10/18 16:39:47 lehors $ */
/*********************************************************************
...
void
#ifdef _NO_PROTO
ProcessTabletEvent( w, xptr, params, num_params )
        Widget w ;
        XEvent *xptr ;
        String *params ;
        Cardinal num_params ;
    ...
    case MotionNotify   : x = xptr->xmotion.x;
                          ...
                          */
                          if (xGrid!=Prev_x || yGrid!=Prev_y){
                             ...
                             str= XmStringCreateLtoR (tmpstr, XmFONTLIST_DEFAULT_TAG);
...
void
#ifdef _NO_PROTO
iRectangle( x, y, width, height, backupFlag )
        int x ;
        int y ;
        int width ;
        int height ;
...
void
#ifdef _NO_PROTO
iArc( x, y, width, height, backupFlag )
        int x ;
        int y ;
        int width ;
        int height ;
