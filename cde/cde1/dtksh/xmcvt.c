/* $XConsortium: xmcvt.c /main/cde1_maint/1 1995/07/18 00:59:48 drk $ */
...
void
#ifdef _NO_PROTO
DtkshCvtXmStringToString( dpy, args, nargs, fval, toval, data )
        Display *dpy ;
        XrmValuePtr args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
...
void
#ifdef _NO_PROTO
DtkshCvtKeySymToString( args, nargs, fval, toval )
        XrmValuePtr args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
        XrmValuePtr toval ;
...
char *
#ifdef _NO_PROTO
_CvtXmStringTableToString( stringtable, itemCount )
...
void
#ifdef _NO_PROTO
DtkshCvtListItemsToString( dpy, args, nargs, fval, toval, data )
        Display *dpy ;
        XrmValuePtr args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
...
void
#ifdef _NO_PROTO
DtkshCvtNamedValueToString( args, nargs, fval, toval )
        XrmValue *args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
        XrmValuePtr toval ;
...
#endif /* _NO_PROTO */
{
	...
	register int i;
        ...
        switch(fval->size)
        {
           case sizeof(char):
           {
	      value = (int)*((char *)fval->addr);
              break;
           }

           case sizeof(short):
           {
	      value = (int)*((short *)fval->addr);
              break;
           }

           case sizeof(long):
           {
	      value = (int)*((long *)fval->addr);
              break;
           }
        }
...
void
#ifdef _NO_PROTO
DtkshCvtStringToNamedValue( args, nargs, fval, toval )
        XrmValue *args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
        XrmValuePtr toval ;
...
void
#ifdef _NO_PROTO
DtkshCvtXEModifierStateToString( args, nargs, fval, toval )
        XrmValuePtr args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
        XrmValuePtr toval ;
...
void
#ifdef _NO_PROTO
DtkshCvtXEMotionHintToString( args, nargs, fval, toval )
        XrmValuePtr args ;
        Cardinal *nargs ;
        XrmValuePtr fval ;
        XrmValuePtr toval ;
...
void
#ifdef _NO_PROTO
DtkshCvtTtStatusToString(ttStatus, pToVal)
        Tt_status ttStatus;
        XrmValue *pToVal;
#else
DtkshCvtTtStatusToString(
...
void
#ifdef _NO_PROTO
DtkshCvtStringToTtStatus(pString, pToVal)
        char *pString;
        XrmValue *pToVal;
#else
DtkshCvtStringToTtStatus(
...
void
#ifdef _NO_PROTO
DtkshCvtStringToBool(pString, pToVal)
        char *pString;
        XrmValue *pToVal;
#else
DtkshCvtStringToBool(
...
void
#ifdef _NO_PROTO
DtkshCvtStringToTtOp(pString, pToVal)
        char *pString;
        XrmValue *pToVal;
#else
DtkshCvtStringToTtOp(
...
void
#ifdef _NO_PROTO
DtkshCvtTtOpToString(op, pToVal)
	Tttk_op op;
        XrmValue *pToVal;
#else
DtkshCvtTtOpToString(
...
void
#ifdef _NO_PROTO
DtkshCvtStringToTtScope(pString, pToVal)
	char *pString;
        XrmValue *pToVal;
#else
DtkshCvtStringToTtScope(
