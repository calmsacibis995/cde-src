/* $XConsortium: dtkcmds.c /main/cde1_maint/4 1995/10/13 23:49:33 montyb $ */
...
static void _DtActionInvokeUsage() ;
...
static void
#ifdef _NO_PROTO
PendingDestroy( w, wtab, callData )
        Widget w ;
        wtab_t *wtab ;
        caddr_t callData ;
#else
...
void
#ifdef _NO_PROTO
parse_args( arg0, argc, argv, w, parent, class, n, args, pargc, pargv,
            postponePixmaps )
        char *arg0 ;
        int argc ;
        char **argv ;
...
int
#ifdef _NO_PROTO
do_XtCreateApplicationShell( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_XtDisplayOfObject( argc, argv )
        int argc ;
        char **argv ;
#else
...
static int
#ifdef _NO_PROTO
GetDisplayHandle( argc, argv, func )
        int argc ;
        char **argv ;
	Widget (*func)();
#else
...
int
#ifdef _NO_PROTO
AddOneCallback( cmd, widget, cbName, kshcmd, propAtomStr )
        char *cmd ;
        char *widget ;
        char *cbName ;
        char *kshcmd ;
...
int
#ifdef _NO_PROTO
RemoveOneCallback( cmd, widget, cbName, kshcmd, propAtomStr, handleStr )
        char *cmd ;
        char *widget ;
        char *cbName ;
        char *kshcmd ;
...
int
#ifdef _NO_PROTO
do_XtAddEventHandler( argc, argv )
        int argc ;
        char **argv ;
#else
...
int
#ifdef _NO_PROTO
do_XtRemoveEventHandler( argc, argv )
        int argc ;
        char **argv ;
#else
...
static int
#ifdef _NO_PROTO
do_RootWindowCmd( func, argc, argv )
        int (*func)() ;
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_XRootWindowOfScreen( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
CatchNonFatalFontError( display, event )
        Display *display ;
        XErrorEvent *event ;
#else
...
static int
#ifdef _NO_PROTO
invokeXDrawFunction( function, argc, argv )
        int function ;
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
ConvertStringToType( arg0, w, parent, class, resource, val, ret, 
...
static Boolean
#ifdef _NO_PROTO
ProcessInput( inp, source, id, eofFound )
        inputrec_t * inp;
        int source;
        XtInputId id;
        Boolean eofFound;
...
void
#ifdef _NO_PROTO
RestorePriorEnvVarValues( np1, value1, np2, value2 )
        Namval_t *np1 ;
        char *value1 ;
        Namval_t *np2 ;
        char *value2 ;
...
void
#ifdef _NO_PROTO
stdWSCB( widget, atom, clientData )
        void *widget ;
        Atom atom ;
        caddr_t clientData ;
#else
...
static int
#ifdef _NO_PROTO
RegisterTranslations( func, argc, argv )
        void (*func)() ;
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_XtOverrideTranslations( argc, argv )
        int argc ;
        char **argv ;
#else
...
int
#ifdef _NO_PROTO
do_XtAugmentTranslations( argc, argv )
        int argc ;
        char **argv ;
#else
...
int
#ifdef _NO_PROTO
do_XtUninstallTranslations( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   if (wtab->parent == NULL) {
	   wtab = (wtab_t *)widget_to_wtab(XtParent(wtab->w));
	   /*
	    * If the widget class has no resources registered, then this is
	    * the first known instance of this widget class, so we need to
	    * force the resource list to be loaded.  This can frequently
...
int
#ifdef _NO_PROTO
do_XtLastTimestampProcessed( argc, argv )
        int argc ;
        char **argv ;
#else
...
dtksh_client_data_t *
#ifdef _NO_PROTO
GetNewCBData( ksh_cmd, w, cbname, propAtom )
        char *ksh_cmd ;
        wtab_t *w ;
        char *cbname ;
        Atom propAtom ;
...
int
#ifdef _NO_PROTO
LocateCBRecord( w, cbname, ksh_cmd, propAtom, handle )
        wtab_t *w ;
        char *cbname ;
        char *ksh_cmd ;
        Atom propAtom ;
...
void
#ifdef _NO_PROTO
stdEH( widget, clientData, event, continueToDispatch )
        void *widget ;
        caddr_t clientData ;
        XEvent *event ;
...
#ifdef _NO_PROTO
GetNewEHData( ksh_cmd, w, eventMask, nonMaskable )
        char *ksh_cmd ;
        wtab_t *w ;
        EventMask eventMask ;
        Boolean nonMaskable ;
...
int
#ifdef _NO_PROTO
do_DtSessionRestorePath( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtSessionSavePath( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtShellIsIconified( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtSetStartupCommand( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   commandAtom = XmInternAtom (XtDisplay(w->w), "WM_COMMAND", False);
...
int
#ifdef _NO_PROTO
do_DtWsmAddWorkspaceFunctions( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmRemoveWorkspaceFunctions( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmGetCurrentWorkspace( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmSetCurrentWorkspace( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
GetWorkspaceList( usageMsg, getOccupied, argc, argv )
        char *usageMsg ;
        Boolean getOccupied ;
        int argc ;
        char *argv[] ;
...
int
#ifdef _NO_PROTO
do_DtWsmGetWorkspaceList( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmGetWorkspacesOccupied( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmSetWorkspacesOccupied( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmGetCurrentBackdropWindow( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmOccupyAllWorkspaces( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do__DtGetHourGlassCursor( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
DtTurnOnOrOffHourGlass( func, argc, argv )
        void (*func)() ;
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do__DtTurnOnHourGlass( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do__DtTurnOffHourGlass( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmAddCurrentWorkspaceCallback( argc, argv )
        int argc ;
        char **argv ;
#else
...
int
#ifdef _NO_PROTO
do_DtWsmRemoveWorkspaceCallback( argc, argv )
        int argc ;
        char **argv ;
#else
...
int
#ifdef _NO_PROTO
do_DtActionDescription( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsLoadDataTypes( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsFileToDataType( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsFileToAttributeValue( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsFileToAttributeList( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsDataTypeToAttributeValue( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsDataTypeToAttributeList( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsFindAttribute( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsDataTypeNames( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_DtDtsDataTypeIsAction( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_tttk_Xt_input_handler( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_ttdt_session_join( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_ttdt_session_quit( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static Tt_message
#ifdef _NO_PROTO
TtFileCB( msg, op, pathName, clientData,sameEuidEgid, sameProcId)
        Tt_message msg;
	Tttk_op op;
	char * pathName;
	void * clientData;
...
int
#ifdef _NO_PROTO
do_ttdt_Get_Modified( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
ttdt_SaveOrRevert( func, argc, argv )
        Tt_status (*func)() ;
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
message_DestroyOrReply( func, argc, argv )
        Tt_status (*func)();
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_tttk_message_destroy( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
message_FailOrReject( func, argc, argv )
        Tt_status (*func)();
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_tttk_message_reject( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_tttk_message_fail( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static int
#ifdef _NO_PROTO
tt_netfile_handler( paramCount, func, usageMsg, argc, argv )
        int paramCount;
        char * (*func)();
        char * usageMsg;
        int argc ;
...
int
#ifdef _NO_PROTO
do_tt_host_file_netfile( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
int
#ifdef _NO_PROTO
do_tt_host_netfile_file( argc, argv )
        int argc ;
        char *argv[] ;
#else
...
static Namdisc_t *
#ifdef _NO_PROTO
CheckClassDisciplines( class, cbname )
        WidgetClass class ;
        char *cbname ;
#else
...
static Namval_t *
#ifdef _NO_PROTO
CreateEmptyNameValuePair( np, name, fp )
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
#else
...
static Namval_t *
#ifdef _NO_PROTO
ProcessIntValue( value, np, name, fp, format, fp_new )
        int value ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessStringValue( value, np, name, fp )
        char *value ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessBooleanIntValue( value, np, name, fp, fp_new )
        int value ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessTraversalDirection( dir, np, name, fp )
        XmTraversalDirection dir ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessSelectionType( selType, np, name, fp )
        char selType ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessIntTable( table, count, np, name, fp )
        int *table ;
        int count ;
        Namval_t *np ;
        char *name ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessXmStringTable( table, count, np, name, fp )
        XmString *table ;
        int count ;
        Namval_t *np ;
        char *name ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessWidgetHandle( handle, np, name, fp )
        Widget handle ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
#endif /* _NO_PROTO */
{
   ...
   np2 = GetNameValuePair(name);
   w = (wtab_t *)widget_to_wtab(handle);
   strcpy(buf, w->widid);
   nv_putval(np2, buf, NV_RDONLY);
...
static Namval_t *
#ifdef _NO_PROTO
ProcessXmStringValue( xmstring, np, name, fp )
        XmString xmstring ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessHyperType( hyperType, np, name, fp )
        int hyperType ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessCallbackEvent( event, np, name, fp )
        XEvent *event ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
_IntProcessCallbackReason( table, cbData, np, name, fp )
        struct named_integer *table ;
        XmAnyCallbackStruct *cbData ;
        Namval_t *np ;
        char *name ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessCallbackReason( cbData, np, name, fp )
        XmAnyCallbackStruct *cbData ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
...
static Namval_t *
#ifdef _NO_PROTO
ProcessHelpCallbackReason( cbData, np, name, fp )
        XmAnyCallbackStruct *cbData ;
        Namval_t *np ;
        char *name ;
        Namfun_t *fp ;
