/* $XConsortium: widget.c /main/cde1_maint/1 1995/07/18 00:58:52 drk $ */
...
static void sort_and_print_res() ;
...
static void
#ifdef _NO_PROTO
gather_resource_list( name, r, notUsed )
        char *name ;
        char *r ;
        void *notUsed ;
#else
...
void
#ifdef _NO_PROTO
alt_env_set_var( variable, value )
        char *variable ;
        char *value ;
#else
alt_env_set_var(
