/* $XConsortium: ispreroot.c /main/cde1_maint/3 1995/10/14 01:03:33 montyb $ */
/***************************************************************
*                                                              *
*                      AT&T - PROPRIETARY                      *
*                                                              *
...
static int
same __PARAM__((const char* a, const char* b), (a, b)) __OTORP__(const char* a; const char* b;){
	int		i;
	int		euid;
	int		ruid;
...
int
ispreroot __PARAM__((const char* dir), (dir)) __OTORP__(const char* dir;){
