/* $XConsortium: init.c /main/cde1_maint/5 1995/10/18 20:34:17 montyb $ */
/***************************************************************
*                                                              *
*                      AT&T - PROPRIETARY                      *
*                                                              *
...
static int localeChanged = 1;
    ...
    void LocaleChanged __PARAM__((Namval_t *np, char *val, int flags, Namfun_t *fp), (np, val, flags, fp)) __OTORP__(Namval_t *np; char *val; int flags; Namfun_t *fp;)
{
   localeChanged = 1;
   nv_putv(np, val, flags, fp);
   setlocale(LC_ALL, "");
    ...
    static char *msg_translate __PARAM__((const char *message,int type), (message, type)) __OTORP__(const char *message;int type;)
{
	...
	if(weFoundIt)
		return GETMESSAGE(allmsgs[midIndex].setNum, allmsgs[midIndex].msgNum, message);
