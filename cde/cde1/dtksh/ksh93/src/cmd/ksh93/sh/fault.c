/* $XConsortium: fault.c /main/cde1_maint/3 1995/10/14 00:12:48 montyb $ */
/***************************************************************
*                                                              *
*                      AT&T - PROPRIETARY                      *
*                                                              *
...
void sh_siginit __PARAM__((void), ()){
	...
	sh.sigmax = n;
	sh.st.trapcom = (char**)calloc(n+1,sizeof(char*));
	sh.sigflag = (unsigned char*)calloc(n+1,1);
	sh.sigmsg = (char**)calloc(n+1,sizeof(char*));
