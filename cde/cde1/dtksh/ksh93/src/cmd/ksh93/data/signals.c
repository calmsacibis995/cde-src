/* $XConsortium: signals.c /main/cde1_maint/3 1995/10/14 00:03:40 montyb $ */
/***************************************************************
*                                                              *
*                      AT&T - PROPRIETARY                      *
*                                                              *
...
#ifdef _SIGRTMAX
	"RTMAX",	VAL(_SIGRTMAX,0),		"Lowest priority realtime signal",
#else
#   ifdef SIGRTMAX
	"RTMAX",	VAL(SIGRTMAX,0),		"Lowest priority realtime signal",
#   endif /* SIGRTMAX */
#endif	/* _SIGRTMAX */
#ifdef _SIGRTMIN
	"RTMIN",	VAL(_SIGRTMIN,0),		"Highest priority realtime signal",
#else
#   ifdef SIGRTMIN
	"RTMIN",	VAL(SIGRTMIN,0),		"Highest priority realtime signal",
#   endif /* SIGRTMIN */
#endif	/* _SIGRTMIN */
#endif	/* SIGQUIT */
