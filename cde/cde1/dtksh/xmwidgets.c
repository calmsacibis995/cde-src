/* $XConsortium: xmwidgets.c /main/cde1_maint/3 1995/10/14 01:41:34 montyb $ */
...
static discInfo * setArrowDisciplines() ;
static discInfo * setCmdDisciplines() ;
static discInfo * setDAreaDisciplines() ;
static discInfo * setDBtnDisciplines() ;
static discInfo * setFSelDisciplines() ;
static discInfo * setListDisciplines() ;
static discInfo * setPBtnDisciplines() ;
static discInfo * setRCDisciplines() ;
static discInfo * setScaleDisciplines() ;
static discInfo * setSBarDisciplines() ;
static discInfo * setSWinDisciplines() ;
static discInfo * setSBoxDisciplines() ;
static discInfo * setTextDisciplines() ;
static discInfo * setTBtnDisciplines() ;
static discInfo * setHelpDisciplines() ;
