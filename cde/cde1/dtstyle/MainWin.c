 ...
 ****************************************************************************
 ************************************<+>*************************************/
/*  $XConsortium: MainWin.c /main/cde1_maint/3 1995/12/11 15:52:30 vobadm $ */
/*+++++++++++++++++++++++++++++++++++++++*/
/* include files                         */
/*+++++++++++++++++++++++++++++++++++++++*/
...
#endif /* _NO_PROTO */
{
   ...
   * save.posArgs may contain information from restoreAudio().*/
    ...
    _XmGetPixelData(style.screenNum, &colorUse, pixelSet, &a, &i, &p, &s);
...
static void 
#ifdef _NO_PROTO
ProcessComponentList(parent,mainRC)
        Widget parent ;
        Widget mainRC ;
#else
ProcessComponentList(
...
static void 
#ifdef _NO_PROTO
activateCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
