 ...
 ****************************************************************************
 ************************************<+>*************************************/
/*$XConsortium: Mouse.c /main/cde1_maint/3 1995/10/09 11:22:00 pascale $*/
...
static void 
#ifdef _NO_PROTO
_DtmapCB_mouseDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
    ...
    if(mouse.accel_denominator == 1) {
      XtSetArg(args[n], XmNvalue, mouse.accel_numerator * 10); n++;
    }
    else {
...
static void 
#ifdef _NO_PROTO
valueChangedCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
     ...
     int     new_acceln, new_acceld, new_thresh, acceln_fraction;
     ...
     acceln_fraction = new_acceln % 10;
 
     if(acceln_fraction == 0) {
        new_acceln = new_acceln / 10;
        new_acceld = 1;  
     }
...
static void 
#ifdef _NO_PROTO
dclickVCCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
dclickTestCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
warnToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
midwarnToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
cancelWarnCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
midcancelWarnCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
reverseToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
midreverseToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
