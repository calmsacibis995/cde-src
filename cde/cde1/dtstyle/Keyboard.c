 ...
 ****************************************************************************
 ************************************<+>*************************************/
/* $XConsortium: Keyboard.c /main/cde1_maint/3 1995/10/23 11:17:51 gtsang $ */
...
static Widget build_keyboardDlg() ;
...
static void 
#ifdef _NO_PROTO
_DtmapCB_keyboardDlg( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
autoRepeatToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
