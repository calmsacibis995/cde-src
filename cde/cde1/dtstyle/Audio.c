 ...
 ****************************************************************************
 ************************************<+>*************************************/
/* $XConsortium: Audio.c /main/cde1_maint/3 1995/10/23 11:06:08 gtsang $ */
/*+++++++++++++++++++++++++++++++++++++++*/
/* include files                         */
/*+++++++++++++++++++++++++++++++++++++++*/
...
static Widget build_audioDlg() ;
static void formLayoutCB() ;
static void _DtmapCB_audioDlg() ;
static int getValue() ;
...
static void 
#ifdef _NO_PROTO
_DtmapCB_audioDlg( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
