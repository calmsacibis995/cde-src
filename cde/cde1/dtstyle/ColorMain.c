 ...
 ****************************************************************************
 ************************************<+>*************************************/
/* $XConsortium: ColorMain.c /main/cde1_maint/3 1995/10/09 11:20:50 pascale $ */
/*+++++++++++++++++++++++++++++++++++++++*/
/* include files                         */
/*+++++++++++++++++++++++++++++++++++++++*/
#ifdef __apollo
...
static Widget           colorButton[MAX_NUM_COLORS];
...
#endif /* _NO_PROTO */
{
    ...
    */
    ...
    /* Not if useColorObj resource is False.  _XmUseColorObj will return false
...
#endif /* _NO_PROTO */
{
    ...
    if (TypeOfMonitor == B_W)      /* create pixmaps for top/bottom shadow */
    {
...
Boolean 
#ifdef _NO_PROTO
InitializePaletteList( shell, list, startup )
        Widget shell ;
        Widget list ;
        Boolean startup ;
#else
...
#endif /* _NO_PROTO */
{
  ...
  while( loop_palette != NULL)
      ...
      else
	{
      ...
      str = CMPSTR(loop_palette->desc);
      XmListAddItem(list, str, loop_palette->item_position);
      XmStringFree(str);
...
#endif /* _NO_PROTO */
{
    ...
    if ((edit.DialogShell == NULL) || (!XtIsManaged(edit.DialogShell)))
    {
        ...
        selected_button = i;
        edit.chip_selected = colorButton[selected_button];
...
#endif /* _NO_PROTO */
{
  ...
  strcpy(tmpstr, tempnam(newPalette->directory, "dt"));
...
#endif /* _NO_PROTO */
{
	...
	string = CMPSTR(((char *)GETMESSAGE(14, 42, "More Colors for Applications")));
        ...
        XtAddCallback(colorDialog.mediumColorTG, XmNvalueChangedCallback, 
                        colorUseCB, (XtPointer)MEDIUM_COLOR);  
...
#endif /* _NO_PROTO */
{
	...
	tmp_palette->item_position == OrgPalette.item_position)
   {
      ...
      for(i = 0; i < MAX_NUM_COLORS; i++)
      {
          ...
          if(i < OrgPalette.num_of_colors && TypeOfMonitor != B_W)
...
#else
       int chipnum = TypeOfMonitor == HIGH_COLOR ? 4 : 1;
       sprintf(xrdb_string, 
