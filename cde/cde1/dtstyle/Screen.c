...
/*$XConsortium: Screen.c /main/cde1_maint/6 1995/12/11 15:55:36 vobadm $*/
...
static Widget build_screenDialog();
static void formLayoutCB();
static void no_svr_ext_formLayoutCB();
static void _DtmapCB_screenDialog();
static void no_svr_ext_DtmapCB_screenDialog();
static void timeOutvalueChangedCB();
static void no_svr_ext_timeOutvalueChangedCB();
static void saverToggleCB();
static void no_svr_ext_saverToggleCB();
static void lockToggleCB();
static void saversToggleCB();
static void systemDefaultCB();
static void no_svr_ext_systemDefaultCB();
static void ButtonCB();
static void no_svr_ext_ButtonCB();
static XmString * MakeListStrings();
static void FreeListStrings();
static void ListCB();
static void IconHandler();
static void UnmapCB();
#else
...
char ** 
#ifdef _NO_PROTO
build_selsaverList(envStr, count)
     char * envStr;
     int * count;
#else
...
char *
#ifdef _NO_PROTO
build_selectedList(saverList, count)
     char ** saverList;
     int     count;
#else
...
void
#ifdef _NO_PROTO
free_saverList(saverList, count)
     char ** saverList;
     int     count;
#else
...
#endif /* _NO_PROTO */
{
	...
	string = XmStringCreateLtoR (savers.current_saverDesc, XmFONTLIST_DEFAULT_TAG);
    else
...
static void 
#ifdef _NO_PROTO
formLayoutCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
no_svr_ext_formLayoutCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
_DtmapCB_screenDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
  ...
  if (first_time)
	...
	screen.saverTimeout_xrdb = SAVER_DEFAULT;
	...
	screen.lockTimeout_xrdb = LOCK_DEFAULT;
  ...
  if((savers.selsaverCount == 1) &&
                (strcmp(savers.current_saver, "StartDtscreenBlank") == 0))
...
static void 
#ifdef _NO_PROTO
no_svr_ext_DtmapCB_screenDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
timeOutvalueChangedCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
no_svr_ext_timeOutvalueChangedCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
saverToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
no_svr_ext_saverToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
lockToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
saversToggleCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
systemDefaultCB( w, client_data, call_data )
     Widget w ;
     XtPointer client_data ;
     XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
no_svr_ext_systemDefaultCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
  ...
  switch (cb->button_position)
      ...
      if (!saverset)
	{
      ...
      /* if saver is "blank screen" only,  set PreferBlanking */
      if((savers.selsaverCount == 1) &&
                (strcmp(savers.current_saver, "StartDtscreenBlank") == 0) &&
		(saverset))
            screen.new_blanking = PreferBlanking;
...
static void 
#ifdef _NO_PROTO
no_svr_ext_ButtonCB( w, client_data, call_data )
     Widget w ;
     XtPointer client_data ;
     XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
ListCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
IconHandler(shell, client_data, event, dispatch)
        Widget shell;
        XtPointer client_data;
        Boolean *dispatch;
        XEvent *event;
...
static void 
#ifdef _NO_PROTO
UnmapCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
