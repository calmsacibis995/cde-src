/* $XConsortium: Backdrop.c /main/cde1_maint/3 1995/10/23 11:07:23 gtsang $ */
/************************************<+>*************************************
 ****************************************************************************
 **
 **   File:        Backdrop.c
...
static int CreateBackdropDialog() ;
static void MoreBitmaps() ;
static ReadBitmaps() ;
static Boolean CreatePixmaps() ;
static ReadBitmapDirectory() ;
...
{   char           *start;
    ...
    strings[0] = XmStringCreateLtoR (_DtOkString, XmFONTLIST_DEFAULT_TAG);
    strings[1] = XmStringCreateLtoR (_DtApplyString, XmFONTLIST_DEFAULT_TAG);
    strings[2] = XmStringCreateLtoR (_DtCloseString, XmFONTLIST_DEFAULT_TAG);
    strings[3] = XmStringCreateLtoR (_DtHelpString, XmFONTLIST_DEFAULT_TAG);
    ...
    XmListSelectPos (list, 1, False);         /* highlight first bitmap */
...
static void 
#ifdef _NO_PROTO
DrawBitmap( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void 
#ifdef _NO_PROTO
SizeBitmap( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
    ...
    for (i = 0; i < backdrops.numBitmaps; i++)
    {
        list[i] = XmStringCreateLtoR (backdrops.bitmapDescs[i], 
