/* $XConsortium: cmnrtns.c /main/cde1_maint/2 1995/10/02 18:01:07 lehors $ */
/*****************************************************************************/
/*                                                                           */
/*  cmnrnts.c                                                                */
/*                                                                           */
...
/*****************************************************************************/
#ifdef _NO_PROTO
void Change_IconGadget_IconType(widIconGadget, pszNewType)
          Widget widIconGadget;
          char *pszNewType;
#else /* _NO_PROTO */
...
/*****************************************************************************/
#ifdef _NO_PROTO
char * Change_IconName_IconType(pszOldName, pszNewType)
          char *pszOldIconName;
          char *pszNewType;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void load_icons (wid, client_data, cbs)
     Widget wid;
     XtPointer client_data;
     XmFileSelectionBoxCallbackStruct *cbs;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void GetWidgetTextString (wid, ppszText)
     Widget  wid;
     char    **ppszText;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void PutWidgetTextString (wid, pszText)
     Widget  wid;
     char    *pszText;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void FreeIconSearchPathList(pplist)
       char **pplist;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void SetIconData(wid, pszIconFile, enumIconSize)
        Widget wid;
        char   *pszIconFile;
...
/******************************************************************************/
#ifdef _NO_PROTO
char * GetCorrectIconType(pszIconFile)
        char   *pszIconFile;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
char * CreateMaskName(pszIconName)
        char   *pszIconName;
#else /* _NO_PROTO */
