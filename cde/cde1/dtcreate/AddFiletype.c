/* $XConsortium: AddFiletype.c /main/cde1_maint/3 1995/10/02 17:59:15 lehors $ */
/***************************************************************************/
/*                                                                         */
/*  AddFiletype.c                                                          */
/*                                                                         */
...
/******************************************************************************/
#ifdef _NO_PROTO
void LayoutCB_AddFiletype(wid, cdata, cbs)
     Widget wid;
     XtPointer cdata;
     XtPointer cbs;
#else /* _NO_PROTO */
...
/******************************************************************************/
#ifdef _NO_PROTO
void activateCB_edit_id_characteristics (filesel, cdata, cbstruct)
     Widget filesel;
     XtPointer cdata;
...
#ifdef _NO_PROTO
static  void    activateCB_AF_OkButton( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
...
#ifdef _NO_PROTO
static  void    activateCB_AF_ApplyButton( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
static  void    activateCB_AF_CancelButton( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
static Widget   _Uxbuild_AddFiletype()
#else /* _NO_PROTO */
...
#define BORDER_OFFSET          3
        ...
        _UxParent = XtVaCreatePopupShell( "AddFiletype_shell",
                        ...
                        XmNtitle, GETMESSAGE(7, 10, "Add Datatype"),
                        NULL );
        /*
...
#endif
        if ((dim1 + dim2 + 3*(FINDEDIT_SPACING)) > dim3) {
           XtVaSetValues(AF_FiletypeIconsEditButton,
...
#ifdef _NO_PROTO
Widget  create_AddFiletype( _UxUxParent )
        swidget _UxUxParent;
#else /* _NO_PROTO */
