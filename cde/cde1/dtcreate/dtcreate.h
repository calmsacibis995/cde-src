/* $XConsortium: dtcreate.h /main/cde1_maint/2 1995/10/02 18:01:43 lehors $ */
/***************************************************************************/
/*                                                                         */
/*  dtcreate.h                                                             */
/*                                                                         */
...
STORAGECLASS  char *ca_icon_default = "Dtactn";
STORAGECLASS  char *ca_full_icon_default =  "/usr/dt/appconfig/icons/C/Dtactn";
STORAGECLASS  char *ca_lrg_icon_default =  "/usr/dt/appconfig/icons/C/Dtactn.l";
STORAGECLASS  char *ca_med_icon_default =  "/usr/dt/appconfig/icons/C/Dtactn.m";
STORAGECLASS  char *ca_sml_icon_default =  "/usr/dt/appconfig/icons/C/Dtactn.s";
STORAGECLASS  char *ca_tiny_icon_default = "/usr/dt/appconfig/icons/C/Dtactn.t";

STORAGECLASS  char *af_icon_default = "Dtdata";
STORAGECLASS  char *af_full_icon_default =  "/usr/dt/appconfig/icons/C/Dtdata";
STORAGECLASS  char *af_lrg_icon_default =  "/usr/dt/appconfig/icons/C/Dtdata.l";
STORAGECLASS  char *af_med_icon_default =  "/usr/dt/appconfig/icons/C/Dtdata.m";
STORAGECLASS  char *af_sml_icon_default =  "/usr/dt/appconfig/icons/C/Dtdata.s";
STORAGECLASS  char *af_tiny_icon_default = "/usr/dt/appconfig/icons/C/Dtdata.t";
...
STORAGECLASS  char *ca_icon_default;
STORAGECLASS  char *ca_full_icon_default;
STORAGECLASS  char *ca_lrg_icon_default;
STORAGECLASS  char *ca_med_icon_default;
STORAGECLASS  char *ca_sml_icon_default;
STORAGECLASS  char *ca_tiny_icon_default;

STORAGECLASS  char *af_icon_default;
STORAGECLASS  char *af_full_icon_default;
STORAGECLASS  char *af_lrg_icon_default;
STORAGECLASS  char *af_med_icon_default;
STORAGECLASS  char *af_sml_icon_default;
STORAGECLASS  char *af_tiny_icon_default;
