/* $XConsortium: CreateActionAppShell.c /main/cde1_maint/4 1995/10/08 00:10:35 pascale $ */
/*******************************************************************************
...
#ifdef _NO_PROTO
char * GetDefinitionFileName( pszName)
            char *pszName;
#else /* _NO_PROTO */
char * GetDefinitionFileName( char *pszName)
#endif /* _NO_PROTO */
{
  char     *pszEnvVar;
...

{
  ...
  if (!bHaveError) {
     ...
     sprintf(buffer, "%s\n\n   %s\n\n",
             GETMESSAGE(5, 70, "The new action"),
             AD.pszName);
     strcat(buffer, GETMESSAGE(5, 71, "has been placed in your home folder."));

#ifdef UNDO_CMVC_3571
       strcat(buffer, "\n\n");
       strcat(buffer, GETMESSAGE(5, 73, "The action definition file that was created is called:"));
       strcat(buffer, "\n   ");
       strcat(buffer, pszFile);
#endif

     display_confirmed_message(CreateActionAppShell, buffer);
...
#ifdef _NO_PROTO
void  questionCB_ReplaceFile( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
void  questionCB_ReplaceFile(Widget UxWidget,
...
#ifdef _NO_PROTO
void  questionCB_CancelSave( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
void  questionCB_CancelSave(Widget UxWidget,
                            XtPointer UxClientData,
                            XtPointer UxCallbackArg)
#endif /* _NO_PROTO */
...
#ifdef _NO_PROTO
void  activateCB_CA_MB_FileSave( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
static  void    activateCB_CA_FiletypesDelete( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
#endif /* _NO_PROTO */
{
  ...
  if (XmListGetSelectedPos(FileTypes, &poslist, &poscnt)) {
     ...
     sprintf(buffer, "%s\n%s",
             ...
             GETMESSAGE(5, 125, "Please select the Datatype you would like to Delete."));
     */
     sprintf(buffer, "%s\n", GETMESSAGE(5, 120, "You have not selected a Datatype from the\n'Datatypes That Use This Action' list."));
     strcat(buffer, GETMESSAGE(5, 125, "Please select the Datatype you would like to Delete."));
     display_error_message(CreateActionAppShell, buffer);
  }
}
...
/*****************************************************************************/
#ifdef _NO_PROTO
static  void    valueChangedCB_CA_WinType( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
/*****************************************************************************/
#ifdef _NO_PROTO
static  void    valueChangedCB_DroppableFiletypes( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
/*****************************************************************************/
#ifdef _NO_PROTO
static  void    activateCB_WindowTypeOptionMenu( UxWidget, UxClientData, UxCallbackArg )
        Widget          UxWidget;
        XtPointer       UxClientData, UxCallbackArg;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
static Widget   _Uxbuild_CreateActionAppShell()
#else /* _NO_PROTO */
...
#define BORDER_OFFSET        3
        ...
        CreateActionAppShell = XtVaCreatePopupShell( "CreateActionAppShell",
                        ...
                        XmNminHeight, -1,
                        */
                        XmNiconName, GETMESSAGE(3, 10, "Create Action"),
                        XmNtitle, GETMESSAGE(3, 10, "Create Action"),
        ...
        */
        ...
        if ((dim1 + dim2 + 3*(FINDEDIT_SPACING)) > ICON_MIN_HEIGHT) {
           XtVaSetValues(CA_EditIcon_button,
...
#ifdef _NO_PROTO
Widget  create_applicationShell1( _UxUxParent )
        swidget _UxUxParent;
#else /* _NO_PROTO */
