/* $XConsortium: Session.c /main/cde1_maint/1 1995/07/18 01:54:17 drk $ */
/************************************************************************
 *
 *  File:	 Session.c
 *
...
#ifdef _NO_PROTO
void
SessionAddFileData (file_name, component_name, component_type, 
                    parent_name, parent_type, delete)
char  * file_name;
char  * component_name;
int     component_type;
char  * parent_name;
...
#ifdef _NO_PROTO
char *
SessionFileNameLookup (component_name, component_type, parent_name, parent_type)
char * component_name;
int    component_type;
char * parent_name;
int    parent_type;
