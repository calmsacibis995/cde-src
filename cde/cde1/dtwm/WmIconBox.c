...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: WmIconBox.c /main/cde1_maint/2 1995/10/09 13:43:59 pascale $"
#endif
#endif
/*
 ...
 *************************************<->***********************************/
#ifdef _NO_PROTO
void AddIconBoxForWorkspace (pWS)
    WmWorkspaceData *pWS;
#else /* _NO_PROTO */
...
#ifdef FWS
    pIBD->IPD.fwsNextIcon = NO_ICON_PLACE;
#endif /* FWS */
...
#endif /* _NO_PROTO */
{
	...
	pCD->pSD->iconBoxTitle = 
	    XmStringCreateLtoR(wmNLS.default_icon_box_title,
...
#ifdef _NO_PROTO
Boolean
IconBoxShowing (pWS, pCW)
    WmWorkspaceData *pWS;
    ControlWindowStruct *pCW;
#else /* _NO_PROTO */
Boolean
...
#ifdef FWS
    place = GetNextIconPlace ((WmWorkspaceData *) NULL, &pIBD->IPD);
#else
