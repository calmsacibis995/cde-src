...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: WmGraphics.c /main/cde1_maint/1 1995/07/15 01:49:48 drk $"
#endif
#endif
/*
 ...
 *************************************<->***********************************/
#ifdef _NO_PROTO
void WmInstallBitmapIntoXmCache (pchName, bitmap, width, height)
 ...
 *************************************<->***********************************/
#ifdef _NO_PROTO
void WmInstallBitmapDataIntoXmCache (pSD, pchName, pData, width, height)
    WmScreenData  *pSD;
    unsigned char *pchName;
    char *pData;
    unsigned int width, height;
