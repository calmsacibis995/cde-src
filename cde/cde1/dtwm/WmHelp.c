/* $XConsortium: WmHelp.c /main/cde1_maint/3 1995/10/11 18:10:30 montyb $ */
#ifdef WSM
/* 
...
static int
#ifdef _NO_PROTO
LocateTheControl( dpy, screen, pWidget )
        Display *dpy ;
        int screen ;
	Widget *pWidget ;
#else
...
#ifdef _NO_PROTO
void WmDtStringHelpCB(theWidget, client_data, call_data)
    Widget theWidget;
    XtPointer client_data;
    XtPointer call_data;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
void WmDtWmStringHelpCB(theWidget, client_data, call_data)
    Widget theWidget;
    XtPointer client_data;
    XtPointer call_data;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
void WmDtDisplayTopicHelp (widget, helpVolume, locationID)
    Widget widget;
    char * helpVolume;
    char * locationID;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
void WmDtDisplayStringHelp (widget, helpString)
    Widget widget;
    char * helpString;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
void WmDtWmTopicHelpCB(theWidget, client_data, call_data)
    Widget theWidget;
    XtPointer client_data;
    XtPointer call_data;
#else /* _NO_PROTO */
...
static WmScreenData *
#ifdef _NO_PROTO
WmScreenDataFromWidget (theWidget) 
    Widget theWidget;	/*  widget id	*/
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtCloseHelpCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtWmCloseHelpCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtWmPopupHelpCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtVersionPopupCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtPopupHelpCB (helpShellW, clientData, callData) 
    Widget		helpShellW;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
...
#endif /* _NO_PROTO */
{
	...
	if (pTemp->workspaces) 
	{
		...
		workspace_atoms = 
		    (Atom *) XtRealloc ((char *)workspace_atoms,
					sizeof (Atom) * (num_workspaces + 1));
		workspace_atoms[num_workspaces] = 
		    XmInternAtom (wmGD.display, pTemp->workspaces, True);
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void WmDtVersionCloseCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
static void WmDtProcessLinkCB (w, clientData, callData) 
    Widget		w;		/*  widget id		*/
    XtPointer		clientData;	/*  data from applicaiton   */
    XtPointer     	callData;	/*  data from widget class  */
#else
    ...
    switch (hyperData->hyperType)
    {
      case DtHELP_LINK_JUMP_NEW:
        WmDtDisplayTopic (XtParent(w), hyperData->helpVolume,
			   hyperData->locationId,DtHELP_LINK_JUMP_NEW, 
			   (Widget)NULL, False,
			   NULL, 0, NULL, True, NULL);
	break;
	
      default:  /* This catches the applicaion definded link types */
...

{
   ...
   if((versionWidget != NULL) &&
	...
	XtSetArg (setArgs2[n2], DtNcloseLabelString, 
	      label=XmStringCreateLtoR ("OK", XmFONTLIST_DEFAULT_TAG)); n2++;
#endif  /* MESSAGE_CAT */
...
#endif /* _NO_PROTO */
{
    ...
    char volume[MAXPATH + 1];
    char topic[MAXPATH + 1];
    int  argCount = 0;
...
static int
#ifdef _NO_PROTO
WmDtReturnSelectedWidget(theWidget, cursor, pWidget)
     Widget   theWidget;
     Cursor   cursor;
     Widget   *pWidget;
#else
...
static void
#ifdef _NO_PROTO
WmDtDisplayTopic(parent, helpVolume, locationId, helpType, 
		       wmClient, wmHelp, argList, argCount, pCData, 
		       hyperLink, displayTopicInfo) 
    Widget  parent;
    char    *helpVolume;
    char    *locationId;
    int     helpType;
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
static Boolean WmDtGetFromCache(pCurrentNode, pSD)
    CacheListStruct **pCurrentNode;
    WmScreenData      *pSD;
#else
static Boolean WmDtGetFromCache(
...
#endif /* _NO_PROTO */
{
    ...
    if ((data = (char *) XtMalloc (MAXPATH+1)) == NULL)
    {
        Warning (((char *)
...
static void
#ifdef _NO_PROTO
wmDtHelpMapEventHandler(wHelp, ptr, pEvent, pBoolean)
        Widget wHelp ;
        XtPointer ptr;
        XEvent  *pEvent;
...
static void
#ifdef _NO_PROTO
wmDtErrorDialog(pSD, sMessage, sTitle)
	WmScreenData *pSD;
...
#endif /* _NO_PROTO */
{
    ...
    xmsMessage = 
	    XmStringCreateLtoR (sMessage, XmFONTLIST_DEFAULT_TAG);
    xmsTitle = 
	    XmStringCreateLtoR (sTitle, XmFONTLIST_DEFAULT_TAG);
	...
	XtSetArg (al[ac], XmNokLabelString, 
	      XmStringCreateLtoR ("OK", XmFONTLIST_DEFAULT_TAG)); ac++;
#endif  /* MESSAGE_CAT */
