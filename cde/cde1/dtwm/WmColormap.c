...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: WmColormap.c /main/cde1_maint/3 1995/10/09 13:42:21 pascale $"
#endif
#endif
/*
...
#ifdef _NO_PROTO
void ForceColormapFocus (pSD, pCD)
    WmScreenData *pSD;
    ClientData *pCD;
...
#ifdef _NO_PROTO
void AddColormapWindowReference (pCD, window)
    ClientData  *pCD;
    Window      window;
#else /* _NO_PROTO */
...
#ifdef _NO_PROTO
void RemoveColormapWindowReference (pCD, window)
    ClientData  *pCD;
    Window      window;
#else /* _NO_PROTO */
