...
static char rcsid[] = "$XConsortium: WmParse.c /main/cde1_maint/1 1995/07/15 01:55:54 drk $";
...
#ifdef _NO_PROTO
void _DtWmParseSkipWhitespace(pWmPB)
...
#ifdef _NO_PROTO
void _DtWmParseSkipWhitespaceC(linePP)
 ...
 *************************************<->***********************************/
#ifdef _NO_PROTO
unsigned int _DtWmParsePeekAhead(currentChar, currentLev)
...
unsigned char *
#ifdef _NO_PROTO
_DtWmParseFilenameExpand (pchFilename)
...
unsigned char *
#ifdef _NO_PROTO
_DtWmParseExpandEnvironmentVariables (pch, pchBrk)
    unsigned char *pch;
