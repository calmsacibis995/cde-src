...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: WmResCvt.c /main/cde1_maint/1 1995/07/15 01:58:08 drk $"
#endif
#endif
/*
...
#ifdef _NO_PROTO
void WmCvtStringToAMBehavior (args, numArgs, fromVal, toVal)
...
#ifdef _NO_PROTO
void WmCvtStringToFrameStyle (args, numArgs, fromVal, toVal)
