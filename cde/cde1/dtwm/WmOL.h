/* $XConsortium: WmOL.h /main/cde1_maint/1 1995/07/18 01:56:33 drk $ */
/* 
 ...
 */
#ifdef _NO_PROTO
extern Boolean HasOpenLookHints();
extern OLWinAttr * GetOLWinAttr();
extern Boolean GetOLDecorFlags();
#else
