 ...
 * Motif Release 1.2.4
*/ 
/*   $XConsortium: WmGlobal.h /main/cde1_maint/4 1995/10/09 13:43:14 pascale $ */
/*
...
#ifdef FWS
/*
 * Define value used to identify placeList entries which are reserved for
 * FWS clients.
 */

#define fwsReserved  ((ClientData *) -1)

    int     fwsNextIcon;    /* placeList entry available for next requestor. */
...
typedef struct _WmScreenData
{
    ...
    int               edgeMoveThreshold;              /* resource */
    ...
    PixelSet	*pPixelData;		/* all pixel data */
    PixelSet	*pActivePixelSet;	/* ptr into pPixelData */
    PixelSet	*pInactivePixelSet;	/* ptr into pPixelData */
    PixelSet	*pPrimaryPixelSet;	/* ptr into pPixelData */
    PixelSet	*pSecondaryPixelSet;	/* ptr into pPixelData */
    PixelSet	*pTextPixelSet;		/* ptr into pPixelData */
...
#ifdef FWS
    Atom                        fwsIconAtom;  /* Atom used for icon property */
#endif /* FWS */
...
#ifdef FWS
    Bool        fwsClient;	       	/* FWS protocol in use. */
    Bool        fwsMapped;              /* FWS client was mapped by client. */
    Bool	fwsAllowStacking;	/* WM can change stacking order. */
    Bool	fwsChangeState;		/* WM can request client change state.*/
    Bool	fwsPassInput;		/* WM passes grabbed input to client. */
#endif
...
#define SM_X                     	(1L << 18) /* X from dtsession */
#define SM_Y                     	(1L << 19) /* Y from dtsession */
#define SM_WIDTH                     	(1L << 20) /* width from dtsession */
#define SM_HEIGHT                    	(1L << 21) /* height from dtsession */
#define SM_CLIENT_STATE                	(1L << 22) /* clientState from dtsession */
#endif /* WSM */
...
typedef struct _WmGlobalData
{
    ...
    Widget	topLevelW;
    MailItem  *mail_items;              /* list of mail gadgets */
#ifdef WSM
