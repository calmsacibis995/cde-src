...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$XConsortium: WmWinList.c /main/cde1_maint/1 1995/07/15 02:01:59 drk $"
#endif
#endif
/*
...
#ifdef _NO_PROTO
Boolean BumpPrimaryToTop (pcdLeader)
	ClientData *pcdLeader;
...
#ifdef _NO_PROTO
Boolean BumpPrimaryToBottom (pcdLeader)
	ClientData *pcdLeader;
