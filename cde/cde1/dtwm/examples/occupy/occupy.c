...
char **argv;
{
     ...
     * create compound string for the button text  
     */
    xms = XmStringCreateLtoR("Set Occupancy", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the button text  
     */
    xms = XmStringCreateLtoR("Occupy All Workspaces", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the button text  
     */
    xms = XmStringCreateLtoR("Show Occupancy", XmFONTLIST_DEFAULT_TAG);
...
Widget top;
{
	...
	for (i=0; i<numWorkspaces; i++, pWid++)
	{
	     ...
	     * create compound string for the button text  
	     */
	    xms = XmStringCreateLtoR(pchWs, XmFONTLIST_DEFAULT_TAG);
