...
char **argv;
{
     ...
     */
    xmsBlank = XmStringCreateLtoR("   ", XmFONTLIST_DEFAULT_TAG);
     ...
     */
    xms = XmStringCreateLtoR("Quit", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the button text  
     */
    xms = XmStringCreateLtoR("Get workspace info", XmFONTLIST_DEFAULT_TAG);
     ...
     */
    xms = XmStringCreateLtoR("Current workspace: ", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the label text  
     */
    xms = XmStringCreateLtoR("    title: ", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the label text  
     */
    xms = XmStringCreateLtoR("    backdrop: ", XmFONTLIST_DEFAULT_TAG);
     ...
     * create compound string for the label text  
     */
    xms = XmStringCreateLtoR("    color set id: ", XmFONTLIST_DEFAULT_TAG);
...
void ShowCurrentWorkspaceInfo ()
{
	...
	if (rval == Success)
	{
	    ...
	    xms = XmStringCreateLtoR(pchName, XmFONTLIST_DEFAULT_TAG);
	    ...
	    /* workspace title */
	    xms = XmStringCreateLtoR(pWsInfo->pchTitle, 
	    ...
	    xms = XmStringCreateLtoR(pch, XmFONTLIST_DEFAULT_TAG);
