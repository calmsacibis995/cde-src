/* $XConsortium: DataBaseLoad.h /main/cde1_maint/2 1995/10/09 13:41:42 pascale $ */
/*****************************************************************************
 *
 *   File:         DataBaseLoad.h
 *
...
#define SWITCH_BUTTON "FPOnItemSwitch"
...
struct _PanelData
{
   ...
   PixelSet * pixel_set;
   PixelSet * active_pixel_set;
   PixelSet * inactive_pixel_set;
   PixelSet * primary_pixel_set;
   PixelSet * secondary_pixel_set;
   int        pixel_set_count;
...
extern Boolean FrontPanelReadDatabases ();
extern void InitParse();
extern void InitializeControlFields();
extern void _WriteControlElementValues();
extern void WriteControlComponentFile();
extern void WriteSubpanelComponentFile();
extern void RemoveControlComponentFile();
extern void RemoveSubpanelComponentFile();
extern void    SessionAddFileData ();
extern void    SessionDeleteFileData ();
extern void    SessionDeleteAll ();
extern char *  SessionFileNameLookup ();
extern void PanelTopicHelpCB();
extern void BoxTopicHelpCB();
extern void SubpanelTopicHelpCB();
extern void SwitchTopicHelpCB();
extern void ControlTopicHelpCB();
extern void GeneralTopicHelpCB();
