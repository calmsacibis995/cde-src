/*
 * $Header: TermData.h,v 1.20 94/12/21 10:46:41 tom_hp_cv Exp $";
 */
...
typedef struct _DtTermDataRec {
     ...
     * Colors
     */
    VtColorPairRec colorPairs[17];	/* color pair pixels		*/
