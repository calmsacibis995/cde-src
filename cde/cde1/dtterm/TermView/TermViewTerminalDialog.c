...
static char rcs_id[] = "$XConsortium: TermViewTerminalDialog.c /main/cde1_maint/2 1995/09/29 12:10:02 lehors $";
...
)
{
    ...
    ac = 0;
    string = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,26, "Terminal - Terminal Options")), XmFONTLIST_DEFAULT_TAG);
    okString = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,2, "OK")), XmFONTLIST_DEFAULT_TAG);
    cancelString = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,3, "Cancel")), XmFONTLIST_DEFAULT_TAG);
    helpString = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,4, "Help")), XmFONTLIST_DEFAULT_TAG);
    resetString = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,25, "Reset")), XmFONTLIST_DEFAULT_TAG);
 ...
 ****************/
    ...
    ac = 0;
    string = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,5, "Keyboard Control")), XmFONTLIST_DEFAULT_TAG);
 ...
 ****************/
    ...
    ac = 0;
    string = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,18, "Screen Control")), XmFONTLIST_DEFAULT_TAG);
    (void) XtSetArg(al[ac], XmNlabelString, string);			ac++;
    (void) XtSetArg(al[ac], XmNchildType, XmFRAME_TITLE_CHILD);		ac++;
    (void) XtSetArg(al[ac], XmNtraversalOn, False);			ac++;
    ...
    ac = 0;
    string = XmStringCreateLtoR((GETMESSAGE(NL_SETN_ViewTerminalDialog,24, "Apply")), XmFONTLIST_DEFAULT_TAG);
    (void) XtSetArg(al[ac], XmNlabelString, string);			ac++;
    ...
    ac = 0;
    (void) XtSetArg(al[ac], XmNmwmFunctions, MWM_FUNC_MOVE | MWM_FUNC_CLOSE);		ac++;
