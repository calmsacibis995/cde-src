/*
 * $XConsortium: TermPrimData.h /main/cde1_maint/2 1995/10/09 11:48:38 pascale $";
 */
...
typedef struct termData {
    ...
    long bufferRows;			/* rows of term buffer memory	*/
    long bufferRowRatio;		/* scaled ratio of term buffer
					 * memory to term window
					 */

    TermBuffer	historyBuffer;		/* history character buffer	*/
    long historyBufferRows;		/* rows of term history buffer	*/
   ...
   /* logging */
    ...
    int uid, gid;                          /* user, group id of user   */
