...
static char rcs_id[] = "$XConsortium: TermPrimRenderLineDraw.c /main/cde1_maint/1 1995/07/15 01:32:43 drk $";
...
)
{
    ...
    termFont->fontInfo = _DtTermPrimLineDrawCreateFont(w, glyphInfo, numGlyphs,
