...
static char rcs_id[] = "$XConsortium: TermPrimDebug.c /main/cde1_maint/1 1995/07/15 01:24:56 drk $";
...
unsigned char *debugLevel[256];		/* debug level			*/
