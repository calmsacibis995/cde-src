...
static char rcs_id[] = "$XConsortium: TermPrimBufferWc.c /main/cde1_maint/1 1995/07/15 01:23:59 drk $";
...
#pragma BBA_IGNORE
    ...
    */
    ...
    /*
    ** if there are characters in the return buffer, return them...
    */
    if (*returnLength > 0)
    {
