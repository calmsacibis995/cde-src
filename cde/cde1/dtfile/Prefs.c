/* $XConsortium: Prefs.c /main/cde1_maint/2 1995/08/29 19:41:01 gtsang $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           Prefs.c
...
#endif /* _NO_PROTO */
{
   ...
   */
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,23, "Headers")),
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,24, "Iconic Path")),
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,36, "Text Path")),
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);                    n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);                 n++;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,37, "Message Line")),
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);                    n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);                 n++;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,18, "Placement")), 
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNtitleString, label_string);         n++;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,20, "As Placed")), 
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);		n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);		n++;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,35, "Rows and Columns")),
                                                 XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);              n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);           n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 7, "Show")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNtitleString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 8, "By Single Folder")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);		n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);		n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_FORM);	n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 9, "By Tree")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 27, "Folders only")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   XtSetArg (args[n], XmNtopWidget, temp);                      n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 28, "Folders, then Files")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   XtSetArg (args[n], XmNtopWidget, temp);                      n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 29, "Folders and Files")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   XtSetArg (args[n], XmNtopWidget, temp);                      n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23,31, "Representation")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNtitleString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   XtSetArg (args[n], XmNtopWidget, position_frame);            n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23,32, "By Name Only")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);		n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);		n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_FORM);	n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23,33, "By Large Icons")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   XtSetArg (args[n], XmNtopWidget, temp);                      n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23,34, "By Small Icons")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23,6, "By Name, date, size ...")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 10, "Order")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNtitleString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 12, "Alphabetically")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);         n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 11, "By File Type")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 13, "By Date")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 14, "By Size")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 15, "Direction")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNtitleString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 16, "Ascending")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);		n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_FORM);		n++;
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(23, 17, "Descending")),
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(23,30, "Defaults")), 
                                      XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);    n++;
   ...
   XtSetArg (args[1], XmNdefaultButton, preferences_rec->apply);
...
static void
#ifdef _NO_PROTO
InstallChange( preferences_rec, callback, client_data )
        PreferencesRec *preferences_rec ;
        XtCallbackProc callback ;
        XtPointer client_data ;
#else
...
static void
#ifdef _NO_PROTO
InstallClose( preferences_rec, callback, client_data )
        PreferencesRec *preferences_rec ;
        XtCallbackProc callback ;
        XtPointer client_data ;
#else
...
static void
#ifdef _NO_PROTO
SetValues( preferences_rec, preferences_data )
        PreferencesRec *preferences_rec ;
        PreferencesData *preferences_data ;
#else
SetValues(
...
static void
#ifdef _NO_PROTO
ResetCallback( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   dialog_data = _DtGetInstanceData (preferences_rec);
...
static void
#ifdef _NO_PROTO
OkCallback( w, apply_data, call_data )
        Widget w ;
        PreferencesApply *apply_data ;
        XtPointer call_data ;
#else
...
void
#ifdef _NO_PROTO
ShowTypeToString( fd, value, out_buf )
        int fd ;
        unsigned char *value ;
        char *out_buf ;
#else
...
void
#ifdef _NO_PROTO
StringToShowType( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
...
void
#ifdef _NO_PROTO
TreeFilesToString( fd, value, out_buf )
        int fd ;
        unsigned char *value ;
        char *out_buf ;
#else
...
void
#ifdef _NO_PROTO
StringToTreeFiles( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
...
void
#ifdef _NO_PROTO
StringToView( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
...
void
#ifdef _NO_PROTO
OrderToString( fd, value, out_buf )
        int fd ;
        unsigned char *value ;
        char *out_buf ;
#else
...
void
#ifdef _NO_PROTO
StringToOrder( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
...
#endif /* _NO_PROTO */
{
   ...
   else
   {
      to_val->size = 0;
      to_val->addr = NULL;
      XtStringConversionWarning ((char *)from_val->addr, DIRECTION);
   }
}
...
void
#ifdef _NO_PROTO
DirectionToString( fd, value, out_buf )
        int fd ;
        unsigned char *value ;
        char *out_buf ;
#else
...
void
#ifdef _NO_PROTO
RandomToString( fd, value, out_buf )
        int fd ;
        unsigned char *value ;
        char *out_buf ;
#else
...
void
#ifdef _NO_PROTO
StringToDirection( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
...
void
#ifdef _NO_PROTO
StringToRandom( args, num_args, from_val, to_val )
        XrmValuePtr args ;
        Cardinal *num_args ;
        XrmValue *from_val ;
        XrmValue *to_val ;
