/* $XConsortium: FileMgr.h /main/cde1_maint/1 1995/07/17 20:39:35 drk $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           FileMgr.h
...
#ifdef  SUN_ACLFS
   Boolean has_acl;              /* has Access Control List */
#endif  /* SUN_ACLFS */
...
typedef struct
{
   ...
   unsigned char view_single;       /* view for single directory */
