/* $XConsortium: ModAttr.c /main/cde1_maint/2 1995/08/29 19:39:40 gtsang $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           ModAttr.c
...
static DialogResource resources[] =
{
   ...
   { "istoolbox", XmRBoolean, sizeof(Boolean),
      XtOffset(ModAttrDataPtr, IsToolBox),
...
#endif /* _NO_PROTO */
{
   ...
   label_string = XmStringCreateLtoR (((char *)
                GETMESSAGE(21,30, "Name: ")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   ...
   label_string = XmStringCreateLtoR ((GETMESSAGE(21,18, "Is Linked To: ")), 
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 3, "Owner Name: ")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_FORM);        n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 4, "Group Name: ")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_FORM);        n++;
   XtSetArg (args[n], XmNleftOffset, 5);                        n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 5, "Permissions:")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_FORM);        n++;
   XtSetArg (args[n], XmNleftOffset, 5);                        n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 6, "Read")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 7, "Write")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);    n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 8, "Execute")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);    n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 9, "Owner:")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);    n++;
   ...
   empty_label_string = XmStringCreateLtoR ("", XmFONTLIST_DEFAULT_TAG);
   n = 0;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 10, "Group:")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);    n++;
   XtSetArg (args[n], XmNleftPosition, 5);                      n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
               GETMESSAGE(21, 11, "Other:")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);                    n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);            n++;
   XtSetArg (args[n], XmNleftPosition, 5);                              n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
           GETMESSAGE(21, 12, "Size (in bytes): ")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);       n++;
   ...
   label_string = XmStringCreateLtoR (((char *)
             GETMESSAGE(21, 13, "Modified: ")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, label_string);            n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_WIDGET);      n++;
...
static void
#ifdef _NO_PROTO
InstallChange( modAttr_rec, callback, client_data )
        ModAttrRec *modAttr_rec ;
        XtCallbackProc callback ;
        XtPointer client_data ;
#else
...
static void
#ifdef _NO_PROTO
InstallClose( modAttr_rec, callback, client_data )
        ModAttrRec *modAttr_rec ;
        XtCallbackProc callback ;
        XtPointer client_data ;
#else
...
static void
#ifdef _NO_PROTO
SetValues( modAttr_rec, modAttr_data )
        ModAttrRec *modAttr_rec ;
        ModAttrData *modAttr_data ;
#else
SetValues(
      ...
      else
      {
        ...
        if (modAttr_data->owner)
        {
          if (getpwnam(modAttr_data->owner) == NULL)
          {
            ...
            sprintf( newstring,"%s ( %s ) ",modAttr_data->owner,
                     GETMESSAGE(21,19, "Unknown") );
            labelString = XmStringCreateLtoR( newstring,XmFONTLIST_DEFAULT_TAG );
            XtFree( newstring );
          }
          else
            labelString = XmStringCreateLtoR(modAttr_data->owner,
                                             XmFONTLIST_DEFAULT_TAG);
        }
        else
        {
          labelString = XmStringCreateLtoR((GETMESSAGE(21,19, "Unknown")),
                                           XmFONTLIST_DEFAULT_TAG);
        }
        ...
        if (modAttr_data->group)
        {
         if (getgrnam(modAttr_data->group) == NULL)
         {
            ...
            labelString = XmStringCreateLtoR(modAttr_data->group,
                                          XmFONTLIST_DEFAULT_TAG);
        }
        else
        {
...
*/
   ...
   if (modAttr_data->name)
   {
      ...
      string = XmStringCreateLtoR(temp, XmFONTLIST_DEFAULT_TAG);
      XtFree ((char *) temp);
   }
   else
   ...
   if (modAttr_data->link_name)
   {
      string = XmStringCreateLtoR(modAttr_data->link_name,
                                  XmFONTLIST_DEFAULT_TAG);
      XtSetArg (args[0], XmNlabelString, string);
   ...
   if (modAttr_data->filetype)
   {
      ...
      if (ptr = (char *)DtDtsDataTypeToAttributeValue(modAttr_data->filetype,
                                                      ...
                                                      NULL))
      {
         string = XmStringCreateLtoR(ptr, XmFONTLIST_DEFAULT_TAG);
         DtDtsFreeAttributeValue(ptr);
      }
      else
      {
         string = XmStringCreateLtoR(modAttr_data->filetype, 
                                     XmFONTLIST_DEFAULT_TAG);
      }
   }
   else
   ...
   if (fsDialogAvailable(fullPath, &modAttr_rec->fileSystem))
   {
      ...
      {
         string = XmStringCreateLtoR (modAttr_rec->fileSystem.buttonLabel, XmFONTLIST_DEFAULT_TAG);
         n = 0;
      ...
      {
         n = 0;
         string = XmStringCreateLtoR (modAttr_rec->fileSystem.warningMessage, XmFONTLIST_DEFAULT_TAG);
         XtSetArg (args[n], XmNlabelString, string);			n++;
         XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);		n++;
         XtSetArg (args[n], XmNtopWidget, modAttr_rec->otherPLabel);	n++;
         XtSetArg (args[n], XmNtopOffset, 15);				n++;
               ...
               strcmp(modAttr_data->filetype,LT_BROKEN_LINK) == 0 ))
   {
     ...
     string = XmStringCreateLtoR(date_string,XmFONTLIST_DEFAULT_TAG);
     XtSetArg (args[0], XmNlabelString, string);
...
#endif /* _NO_PROTO */
{
  ...
  old_dialog = _DtGetInstanceData (modAttr_rec);
  ...
  else if (result == NO_FILE)
  {
     ...
     ModAttrClose (file_mgr_rec, old_dialog, NULL);
...
static short
#ifdef _NO_PROTO
GetModAttrValues( modAttr_rec, modAttr_data, validate )
        ModAttrRec *modAttr_rec ;
        ModAttrData *modAttr_data ;
        Boolean validate ;
#else
...
static void
#ifdef _NO_PROTO
InvalidModAttrMessage( w, messageIndex )
        Widget w ;
        int messageIndex ;
#else
InvalidModAttrMessage(
...
static Boolean
#ifdef _NO_PROTO
_LoadFileAttributes( host, dir, file, modAttr_data, mask )
        String host ;
        String dir ;
        String file ;
        ModAttrData *modAttr_data ;
...
#endif /* _NO_PROTO */
{
   ...
   file_data = (FileData *) ReadFileData(dir,file,modAttr_data->IsToolBox);

   if (file_data && (file_data->errno == 0 || file_data->link))
   {
          ...
          (file_data->stat.st_mode & S_IFMT) != S_IFLNK )
      {
         if (mask & GROUP)
         {
            ...
            {
               sprintf(buf, "%d", file_data->stat.st_gid);
         ...
         if (mask & OWNER)
         {
            ...
            {
               sprintf(buf, "%d", file_data->stat.st_uid);
...
Boolean
#ifdef _NO_PROTO
LoadFileAttributes( host, dir, file, modAttr_data )
        String host ;
        String dir ;
        String file ;
        ModAttrData *modAttr_data ;
...
{ 
   ...
   switch ((pid = fork()))
   {
      case -1:  /* error forking */
         ...
         xm_string = XmStringCreateLtoR(s, XmFONTLIST_DEFAULT_TAG);
         n = 0;
      ...
      case 0:  /* child */
         DPRINTF(("in child after forking file system dialog\n"));
...
static void
#ifdef _NO_PROTO
DontChangeCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void
#ifdef _NO_PROTO
ChangeCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
void
#ifdef _NO_PROTO
ModAttrFreeValues( modAttr_data )
        ModAttrData *modAttr_data ;
#else
ModAttrFreeValues(
        ModAttrData *modAttr_data )
