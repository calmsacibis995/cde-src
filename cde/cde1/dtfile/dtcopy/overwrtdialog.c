/* $XConsortium: overwrtdialog.c /main/cde1_maint/2 1995/08/29 19:45:52 gtsang $ */
/************************************<+>*************************************
 ****************************************************************************
 *
...
static void
#ifdef _NO_PROTO
confirmtoggle_callback(w, client_data, call_data)
	Widget w;
	XtPointer client_data;
	XtPointer call_data;
#else
...
void
#ifdef _NO_PROTO
create_overwrite_dialog(parent_widget, sname, tname, isdir)
...
#endif
{
  ...
  msg = XmStringCreateLtoR(GETMESSAGE(5, 8, "Action to take:"), XmFONTLIST_DEFAULT_TAG);
  ...
  xm_string[G_OVERWRITE_EXISTING] = XmStringCreateLtoR(
                        GETMESSAGE(5, 3, "Replace existing file"),
                        XmFONTLIST_DEFAULT_TAG);
  xm_string[G_RENAME_EXISTING] = XmStringCreateLtoR(
                        GETMESSAGE(5, 4, "Rename existing file to:"),
                        XmFONTLIST_DEFAULT_TAG);
  xm_string[G_SKIP] = XmStringCreateLtoR(
  ...
  msg = XmStringCreateLtoR(GETMESSAGE(5, 7, "Apply this action to subsequent name conflicts"),
                           XmFONTLIST_DEFAULT_TAG);
