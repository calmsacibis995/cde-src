/* $XConsortium: sharedFuncs.h /main/cde1_maint/3 1995/10/09 14:54:30 pascale $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           sharedFuncs.h
...
#ifdef _NO_PROTO
extern int       auto_rename();
extern void      generate_NewPath();
extern void      split_path();
extern String    build_path();
extern XImage  * CreateDefaultImage();
extern void      ImageInitialize();
