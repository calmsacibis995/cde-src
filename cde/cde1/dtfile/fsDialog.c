/* $XConsortium: fsDialog.c /main/cde1_maint/2 1995/10/09 14:52:49 pascale $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           fsDialog.c
...
#ifdef _NO_PROTO
static void     getFSType ();
static void     readConfigFile();
static String   configFileName();
static void     readFSID ();
static void     readDialogData();
static int      readLine();
static int      stricmp();
static String   strip();
static Boolean  configFileOK();
#else                       
...
Boolean
#ifdef _NO_PROTO
fsDialogAvailable (path, fsDialogData)
   const String   path;
   dtFSData *fsDialogData;
#else
...
#ifdef _NO_PROTO
static void getFSType(path, fsType, platform)
   const String  path;
         String  fsType, platform;
#else
static void getFSType(const String  path,
                            String  fsType,
                            String  platform)
