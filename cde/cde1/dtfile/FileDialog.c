/* $XConsortium: FileDialog.c /main/cde1_maint/3 1995/10/09 14:48:08 pascale $ */
/************************************<+>*************************************
 ****************************************************************************
 *
 *   FILE:           FileDialog.c
...
void
#ifdef _NO_PROTO
ShowRenameFileDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
void
#ifdef _NO_PROTO
ShowCopyFileDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   label_string = XmStringCreateLtoR (name_string, XmFONTLIST_DEFAULT_TAG);
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 8, "File Type")), XmFONTLIST_DEFAULT_TAG);
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 34, "Destination Folder: ")), XmFONTLIST_DEFAULT_TAG);
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 38, "Name for copy : ")), XmFONTLIST_DEFAULT_TAG);
   ...
   label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 36, "Show Icon")), XmFONTLIST_DEFAULT_TAG);
...
void
#ifdef _NO_PROTO
ShowMoveFileDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
void
#ifdef _NO_PROTO
ShowLinkFileDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
static void
#ifdef _NO_PROTO
RenameOk( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   file_set[0] = (char *) build_path(call_struct->directory_name, call_struct->file_name);
...
static Boolean
#ifdef _NO_PROTO
GetToPath (to, new_name, host_in, dir_in)
        char *to;
        char *new_name;
        char *host_in;
        char *dir_in;
...
static void
#ifdef _NO_PROTO
FileTypePreviewCB( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   else if (link_path = _DtFollowLink(whole_name))
   {
      ...
      else
      {
         ...
         int scr = XScreenNumberOfScreen(XtScreen(call_struct->menu_widget));
         if (call_struct->menu_widget == gMenuWidgets[scr].renameBtn)
#else
   ...
   if (file_type)
   {
      ...
      if (DtActionExists(file_type))
      {
         ...
         if(str != NULL)
           string = XmStringCreateLtoR(str, XmFONTLIST_DEFAULT_TAG);
         else
           string = XmStringCreateLtoR(file_type, XmFONTLIST_DEFAULT_TAG);
         XtFree(str);
      }
      else
      {
         ...
         {
            string = XmStringCreateLtoR(file_type,
...
void
#ifdef _NO_PROTO
ShowMakeFileDialog( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   dialog_data = _DtGetInstanceData (file_mgr_rec);
   if (dialog_data == 0) {  /* XXX race? */
       fprintf( stderr, "dtfile[%d]: ShowMakeFileDialog(): "
		"assert(dialog_data != 0)\n", getpid() );
   ...
   if (w == *create_directoryBtn)
   {
      ...
      label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 16, "New Folder Name: ")), XmFONTLIST_DEFAULT_TAG);
   }   
   else if (w == *create_dataBtn)
   {
      ...
      label_string = XmStringCreateLtoR (((char *)GETMESSAGE(10, 7, "New File Name: ")), XmFONTLIST_DEFAULT_TAG);
   }
   XtFree(tempStr);
...
static void
#ifdef _NO_PROTO
MakeFileOk( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#ifdef _TT_MULTI_SCREEN
   int      scr = XScreenNumberOfScreen(XtScreen(w));
   Widget*  create_directoryBtn = &(gMenuWidgets[scr].create_directoryBtn);
#endif
...
static void
#ifdef _NO_PROTO
MakeFileDone(client_data, to, rc)
        XtPointer client_data;
        char *to;
        int rc;
#else
...
static void
#ifdef _NO_PROTO
MakeFileApply( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   if (call_struct->menu_widget == gMenuWidgets[scr].create_directoryBtn)
#else
   if (call_struct->menu_widget == *create_directoryBtn)
#endif
   {
...
static void
#ifdef _NO_PROTO
ApplyFileDone(client_data, to, rc)
        XtPointer client_data;
        char *to;
        int rc;
#else
...
static void
#ifdef _NO_PROTO
DialogCancel( w, client_data, call_data )
        Widget w ;
        XtPointer client_data ;
        XtPointer call_data ;
#else
...
#endif /* _NO_PROTO */
{
   ...
   Widget* renameBtn = &(gMenuWidgets[scr].renameBtn);
   Widget* moveBtn =  &(gMenuWidgets[scr].moveBtn);
   Widget* duplicateBtn =  &(gMenuWidgets[scr].duplicateBtn);
   Widget* linkBtn =  &(gMenuWidgets[scr].linkBtn);
   Widget* create_directoryBtn =  &(gMenuWidgets[scr].create_directoryBtn);
   Widget* create_dataBtn =  &(gMenuWidgets[scr].create_dataBtn);
#endif
   ...
   dialog_data = _DtGetInstanceData (call_struct->file_mgr_rec);
   file_mgr_data = (FileMgrData *) dialog_data->data;
