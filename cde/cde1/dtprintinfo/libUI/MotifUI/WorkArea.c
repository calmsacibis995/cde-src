/* $XConsortium: WorkArea.c /main/cde1_maint/2 1995/10/23 10:20:36 gtsang $ */
#include "WorkAreaP.h"
   ...
   Cardinal argcount)
{
   ...
   XtAddCallback(sworkArea, XmNdestroyCallback, _XmDestroyParentCallback,NULL);
   ...
   Widget w)
{
   ...
   if (GuiIsWorkArea(w))
      ...
      _XmWarning(w, "Cannot set DisableRedisplay of non-subclass of WorkArea");
}
   ...
   if (GuiIsWorkArea(w))
    {
      ...
      _XmWarning(w, "Cannot set EnableRedisplay of non-subclass of WorkArea");
}
   ...
   Region region)
{
    ...
    */
   if (!w->workArea.is_list && XtIsRealized(w) &&
