/* $XConsortium: Util.c /main/cde1_maint/1 1995/07/17 21:02:33 drk $ */
/*************************************<+>*************************************
 *****************************************************************************
 **
 **   File:         Util.c
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
void CloseAndExitCB(w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void CloseQuickHelpCB(w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
void CloseHelpCB (w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
void ProcessLinkCB (w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
void DisplayTopic(parent, helpVolume, locationId, argc, argv)
    Widget  parent;
    char    *helpVolume;
    char    *locationId;
    int     argc;
...
#ifdef HAVE_EDITRES
        XtAddEventHandler(XtParent(pCurrentNode->helpDialog),
                          0,
                          True,
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
Boolean GetFromCache(parent, pCurrentNode)
    Widget parent;
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
void DisplayMan(parent, man, closeOption)
    Widget  parent;
    char    *man;
    int     closeOption;
#else
  ...
  if (viewWidget == NULL)
    {
      ...
      backString = XmStringCreateLocalized((char *)_DTGETMESSAGE(7, 18,"Backtrack"));

      if (closeOption == EXIT_ON_CLOSE)
          exitString = XmStringCreateLocalized((char *)_DTGETMESSAGE(7, 16,"Exit"));
      else
          exitString = XmStringCreateLocalized((char *)_DTGETMESSAGE(7, 17,"Close"));
