/* $XConsortium: ManPage.c /main/cde1_maint/1 1995/07/17 21:02:03 drk $ */
/*************************************<+>*************************************
 *****************************************************************************
 **
 **   File:         ManPage.c
...
#endif /* _NO_PROTO */
{
  ...
  XmAddWMProtocolCallback(XtParent(widget),wm_delete_window,
                          (XtCallbackProc)CloseAndExitCB, widget);
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
void PostManDialog(parent, argc, argv)
    Widget parent;
    int     argc;
    char    **argv;
#else
...

{
  ...
  Pixel foregroundColor;
   ...
   labelStr = XmStringCreateLocalized((char *)_DTGETMESSAGE(7, 13, "Show Man Page"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelStr);			n++;
...
#ifdef _NO_PROTO
static void ManTextUpdateCB( widget, client_data, call_data )
    Widget widget ;
    XtPointer client_data ;
    XtPointer call_data ;
#else
 ...
 *******************************************************************/
#ifdef _NO_PROTO
static void ManDisplayCB( widget, client_data, call_data )
    Widget widget ;
    XtPointer client_data ;
    XtPointer call_data ;
#else
