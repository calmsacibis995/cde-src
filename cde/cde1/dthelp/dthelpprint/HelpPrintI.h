...
$REVISION$:  $XConsortium: HelpPrintI.h /main/cde1_maint/2 1995/10/08 23:57:26 pascale $
$CHGLOG$:
$COPYRIGHT$:
...
#ifdef MESSAGE_CAT
#define _DTGETMESSAGE(set, number, string) _DtHPrGetMessage(set, number, string)
#else /* MESSAGE_CAT */
