...
$REVISION$:  $XConsortium: PrintManStrFile.c /main/cde1_maint/1 1995/07/14 23:38:45 drk $
$CHGLOG$:    
$COPYRIGHT$:
...
#if _NO_PROTO
int _DtHPrPrintStringData(dpy, options)
   Display *dpy;
...
#if _NO_PROTO
int _DtHPrPrintDynamicStringData(dpy, options)
   Display *dpy;
   _DtHPrOptions * options;
#else   /*$DEF$*/
...
#if _NO_PROTO
int _DtHPrPrintManPage(dpy, options)
   Display *dpy;
  _DtHPrOptions * options;
#else   /*$DEF$*/
...
#if _NO_PROTO
int _DtHPrPrintHelpFile(dpy, options)
   Display *dpy;
  _DtHPrOptions * options;
#else   /*$DEF$*/
