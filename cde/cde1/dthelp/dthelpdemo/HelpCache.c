/* $XConsortium: HelpCache.c /main/cde1_maint/1 1995/07/17 20:59:33 drk $ */
/*************************************<+>*************************************
 *****************************************************************************
 **
 **  File:        HelpCache.c
 ...
 ***************************************************************************/
#ifdef _NO_PROTO
static void CloseMainCB (w, clientData, callData) 
    Widget		w;
    XtPointer		clientData;
    XtPointer     	callData;
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
static Boolean GetFromCache(parent, pCurrentNode)
    Widget parent;
    CacheListStruct **pCurrentNode;
#else
static Boolean GetFromCache(
