...
class OptCmd: public WarnNoUndoCmd {
  ...
  public:
    ...
    void init_logging();  // initialize log text state in message filing pane
    ...
    Boolean _startDateFormatError;
    Boolean _endDateFormatError;
    Boolean windowIsAlive() { return _window_alive; }
    void setWindowAlive(Boolean wa) { _window_alive = wa; }
  ...
  private:
    ...
    Boolean vacation_date_changed;
    Boolean vacation_onoff_changed;
    Boolean _window_alive;
