...
#pragma ident "@(#)ButtonGadgetInterface.C	1.1 03/05/96"
#endif
...
//////////////////////////////////////////////////////////////
// ButtonGadgetInterface.C: A push button interface to a Cmd object
///////////////////////////////////////////////////////////////
#include <stdlib.h>
#include <ctype.h>
...
ButtonGadgetInterface::ButtonGadgetInterface ( Widget parent, 
				  Cmd *cmd ) : CmdInterface ( cmd )
{
    ...
    //
    char w_name[200];
    ButtonInterface::mapName(_name, w_name);
...
ButtonGadgetInterface::~ButtonGadgetInterface(void)
{
}
