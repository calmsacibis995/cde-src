...
#pragma ident "@(#)Editor.hh	1.48 04/05/96"
#endif
...
class Editor : public UIComponent {
  ...
  public:	
    ...
    virtual int	append_to_contents(const char * path) = 0;
    virtual int	update_contents(void) = 0;

    virtual int	append_at_cursor(const char *path) = 0;
    ...
    virtual DtMailBoolean	set_message(DtMail::Message * msg,
					    char ** status_string,
    ...
    virtual void	set_editable(Boolean bool) = 0;
	...
	virtual void    set_word_wrap(Boolean bool) = 0;
