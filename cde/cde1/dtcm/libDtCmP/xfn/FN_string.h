...
#pragma ident	"@(#)FN_string.h	1.3	94/11/20 SMI"
...
/*
 * Known deviations from XFN draft spec:
 *
 * 1. Enum for index_none, index_first, index_last.
 */
...
extern FN_string_t *fn_string_from_contents(
	...
	const void *contents,
	unsigned int *status);
extern unsigned long fn_string_code_set(
