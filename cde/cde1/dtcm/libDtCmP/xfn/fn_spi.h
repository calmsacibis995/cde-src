...
#pragma ident	"@(#)fn_spi.h	1.4	94/11/20 SMI"
...
typedef FN_ctx_svc_t *(*FN_ctx_svc_from_ref_func)(const FN_ref_t *,
    FN_status_t *);
typedef FN_ctx_svc_t *(*FN_ctx_svc_from_initial_func)(FN_status_t *);
/* ************* generic interface types and values ****************** */
#define	 FN_CTX_SVC_FUNC_SIZE 15
enum {
	FN_CTX_SVC_FUNC_LOOKUP,
	FN_CTX_SVC_FUNC_LIST_NAMES,
	FN_CTX_SVC_FUNC_LIST_BINDINGS,
	FN_CTX_SVC_FUNC_BIND,
	FN_CTX_SVC_FUNC_UNBIND,
	FN_CTX_SVC_FUNC_CREATE_SUBCONTEXT,
	FN_CTX_SVC_FUNC_DESTROY_SUBCONTEXT,
	FN_CTX_SVC_FUNC_RENAME,
	FN_CTX_SVC_FUNC_GET_SYNTAX_ATTRS,
	FN_CTX_SVC_FUNC_ATTR_GET,
	FN_CTX_SVC_FUNC_ATTR_MODIFY,
	FN_CTX_SVC_FUNC_ATTR_GET_VALUES,
	FN_CTX_SVC_FUNC_ATTR_GET_IDS,
	FN_CTX_SVC_FUNC_ATTR_MULTI_GET,
	FN_CTX_SVC_FUNC_ATTR_MULTI_MODIFY
};
typedef void (*FN_ctx_svc_func_t)();
typedef void *FN_ctx_svc_data_t;
typedef FN_ctx_svc_func_t FN_ctx_svc_func_array_t[FN_CTX_SVC_FUNC_SIZE];
