...
**  dssw.c
**
**  $XConsortium: dssw.c /main/cde1_maint/5 1995/11/14 15:15:02 drk $
**
...
#pragma ident "@(#)dssw.c	1.62 96/11/12 Sun Microsystems, Inc."
	...
	Boolean 	 show_allday)
{
	...
	*/
	...
	label_str = XtNewString(catgets(c->DT_catd, 1, 828, "Date:"));
        dssw->date_label = XtVaCreateWidget(
		label_str,
		xmLabelGadgetClass, 	dssw->dssw_form_mgr,
                NULL);
	XtFree(label_str);

	label_str = XtNewString(catgets(c->DT_catd, 1, 829, "Start:"));
        dssw->start_label = XtVaCreateWidget(
		label_str,
		xmLabelGadgetClass, 	dssw->dssw_form_mgr,
                NULL);
	XtFree(label_str);

	label_str = XtNewString(catgets(c->DT_catd, 1, 832, "End:"));
        dssw->stop_label = XtVaCreateWidget(
		label_str,
		xmLabelGadgetClass, 	dssw->dssw_form_mgr,
                NULL);
	XtFree(label_str);

	label_str = XtNewString(catgets(c->DT_catd, 1, 835, "What:"));
        dssw->what_label = XtVaCreateWidget(
		label_str,
		xmLabelGadgetClass, 	dssw->dssw_form_mgr,
                NULL);
	XtFree(label_str);

	max_left_label_width = ComputeMaxWidth(dssw->date_label,
						dssw->start_label,
						dssw->stop_label,
						dssw->what_label) + GAP;
	...
	*/
	dssw->start_text = XtVaCreateWidget("start_text",
		xmTextWidgetClass, 	dssw->dssw_form_mgr,
		XmNeditMode, 		XmSINGLE_LINE_EDIT,
		XmNcolumns, 		START_STOP_LEN,
		XmNmaxLength, 		START_STOP_LEN - 1,
		XmNleftAttachment, 	XmATTACH_FORM,
		XmNleftOffset, 		max_left_label_width,
		XmNtopAttachment, 	XmATTACH_WIDGET,
		XmNtopWidget, 		dssw->date_text,
		XmNtopOffset, 		GAP,
		NULL);
	...
	XtVaSetValues(dssw->start_menu,
		...
		XmNbottomWidget, 	dssw->start_text,
		XmNbottomOffset, 	-2,
		XmNleftAttachment, 	XmATTACH_WIDGET,
		XmNleftWidget, 		dssw->start_text,
		XmNleftOffset, 		-2,
		NULL);
		...
		XmNbottomAttachment, 	XmATTACH_OPPOSITE_WIDGET,
		XmNbottomWidget, 	dssw->start_menu,
		XmNleftAttachment, 	XmATTACH_WIDGET,
		XmNleftWidget, 		dssw->start_menu,
		XmNleftOffset, 		GAP,
		NULL);

	label_str = XtNewString(catgets(c->DT_catd, 1, 830, "AM"));
        child[0] = dssw->start_am = XtVaCreateWidget(
		label_str,
	...
	label_str = XtNewString(catgets(c->DT_catd, 1, 831, "PM"));
        child[1] = dssw->start_pm = XtVaCreateWidget(
		label_str,
		xmToggleButtonGadgetClass, dssw->start_ampm_rc_mgr,
		XmNsensitive, 		(dt == HOUR12) ? True : False,
		NULL);      
	...
	*/
	...
	XtVaSetValues(dssw->stop_menu,
		XmNnavigationType, 	XmTAB_GROUP,
		XmNbottomAttachment, 	XmATTACH_OPPOSITE_WIDGET,
		XmNbottomWidget, 	dssw->stop_text,
		XmNbottomOffset, 	-2,
		XmNleftAttachment, 	XmATTACH_WIDGET,
		XmNleftWidget, 		dssw->stop_text,
		XmNleftOffset, 		-2,
		NULL);
		...
		XmNentryClass, 		xmToggleButtonGadgetClass,
		XmNbottomAttachment, 	XmATTACH_OPPOSITE_WIDGET,
		XmNbottomWidget, 	dssw->stop_menu,
		XmNleftAttachment, 	XmATTACH_WIDGET,
		XmNleftWidget, 		dssw->stop_menu,
		XmNleftOffset, 		GAP,
		NULL);

	label_str = XtNewString(catgets(c->DT_catd, 1, 833, "AM"));
        child[0] = dssw->stop_am = XtVaCreateWidget(
		label_str,
	...
	label_str = XtNewString(catgets(c->DT_catd, 1, 834, "PM"));
        child[1] = dssw->stop_pm = XtVaCreateWidget(
		label_str,
		xmToggleButtonGadgetClass, dssw->stop_ampm_rc_mgr,
		XmNsensitive, 		(dt == HOUR12) ? True : False,
		NULL);      
...
/*	XtSetArg(args[n], XmNscrollVertical, 	True), n++;  */
	...
	XtSetArg(args[n], XmNtopWidget, 	dssw->stop_text), n++;
	XtSetArg(args[n], XmNtopOffset, 	GAP), n++;
	XtSetArg(args[n], XmNleftAttachment, 	XmATTACH_FORM), n++;
	XtSetArg(args[n], XmNleftOffset, 	max_left_label_width), n++;
	...
	XtManageChild(dssw->what_text);
		...
		XmNbottomAttachment,    XmATTACH_OPPOSITE_WIDGET,
                XmNbottomWidget,        dssw->date_text,
                XmNbottomOffset,        GAP,
                XmNrightAttachment,     XmATTACH_WIDGET,
                XmNrightWidget,         dssw->date_text,
                XmNrightOffset,         GAP,
                NULL);
		...
		XmNbottomAttachment,    XmATTACH_OPPOSITE_WIDGET,
                ...
                XmNbottomOffset,        GAP,
                XmNrightAttachment,     XmATTACH_WIDGET,
                XmNrightWidget,         dssw->start_text,
                XmNrightOffset,         GAP,
                NULL);
		...
		XmNbottomAttachment,    XmATTACH_OPPOSITE_WIDGET,
                ...
                XmNbottomOffset,        GAP,
                XmNrightAttachment,     XmATTACH_WIDGET,
                XmNrightWidget,         dssw->stop_text,
                XmNrightOffset,         GAP,
                NULL);

        XtVaSetValues(dssw->what_label,
		XmNtopAttachment,    	XmATTACH_WIDGET,
                XmNtopWidget,		dssw->stop_text,
                XmNtopOffset,		GAP,
                XmNrightAttachment,     XmATTACH_WIDGET,
                XmNrightWidget,         dssw->what_text,
                XmNrightOffset,         GAP,
                NULL);
}
	...
	*/
	...
	if (!blank_buf(dssw->stop_val.val)) {
		...
		if (stop_tick < start_tick) {
			...
			answer = dialog_popup(dssw->parent,
				DIALOG_TITLE, title,
				DIALOG_TEXT, buf,
