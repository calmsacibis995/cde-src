...
**  alarm.c
**
**  $XConsortium: alarm.c /main/cde1_maint/4 1995/11/14 16:55:05 drk $
**
...
#pragma ident "@(#)alarm.c	1.54 96/11/12 Sun Microsystems, Inc."
...
mail_it(XtPointer client_data, XtIntervalId *interval_id, CSA_reminder_reference *r) {
	...
	if (showtime_set(appt) && appt->end_time) {
	...
	if (appt->type->value->item.sint32_value != CSA_TYPE_TODO) {
