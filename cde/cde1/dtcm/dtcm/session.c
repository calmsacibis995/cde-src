...
**  session.c
**
**  $XConsortium: session.c /main/cde1_maint/2 1995/09/06 08:15:22 lehors $
**
...
#pragma ident "@(#)session.c	1.7 96/03/04 Sun Microsystems, Inc."
	...
	XtPointer 	 callbackArg)
{
	...
	command_atom = XmInternAtom(XtDisplay(calendar->frame), 
							"WM_COMMAND", False);
