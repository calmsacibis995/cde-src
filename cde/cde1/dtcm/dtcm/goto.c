...
**  goto.c
**
**  $XConsortium: goto.c /main/cde1_maint/3 1995/11/14 16:57:56 drk $
**
...
#pragma ident "@(#)goto.c	1.44 96/11/12 Sun Microsystems, Inc."
...
make_goto(Calendar *c)
{
	...
	if (c->goTo == NULL) {
                c->goTo = (caddr_t)XtCalloc(1, sizeof(Goto));
                g = (Goto*)c->goTo;
        }
        else
                g = (Goto*)c->goTo;
