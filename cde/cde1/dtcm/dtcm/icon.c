/* $XConsortium: icon.c /main/cde1_maint/2 1995/09/06 08:11:04 lehors $ */
/*
...
#pragma ident "@(#)icon.c	1.5 96/03/04 Sun Microsystems, Inc."
	...
	Calendar	*c)
{
	...
	if (!c->icon)
		c->icon = (IconInfo *) XtCalloc(1, sizeof(IconInfo));
	if (!c->icon_inverted)
		c->icon_inverted = (IconInfo *) XtCalloc(1, sizeof(IconInfo));
