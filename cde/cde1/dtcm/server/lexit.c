/* $XConsortium: lexit.c /main/cde1_maint/2 1995/10/03 12:31:09 barstow $ */
/*
...
#pragma ident "@(#)lexit.c	1.6 96/11/12 Sun Microsystems, Inc."
...
static int 	hash_string(register char *);
...
setinput (FILE* f)
{
#if !defined(USL) && !defined(__uxp__)	/* no madvise so we lose this optimization */
  extern int madvise(caddr_t addr, size_t len, int advise);
