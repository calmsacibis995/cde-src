/* $XConsortium: dsdm.c /main/cde1_maint/1 1995/07/17 19:29:34 drk $ */
#pragma ident	"@(#)oldsdm:dsdm.c	1.11"
...
#if XlibSpecificationRelease == 5	/*USL*/
    ...
    Display *dpy;
{
    ...
    while (site != NULL) {
	printf("sid %d   wid 0x%08x   flags 0x%08x\n",
