#ifndef _CLNT_INCLUDED
#define _CLNT_INCLUDED
#ifdef MODULE_ID
/*
 * @(#)clnt.h: $Revision: 1.1 $ $Date: 93/09/02 07:14:53 $
 * $Locker:  $
 */
#endif /* MODULE_ID */
/*
...
typedef struct {
	...
	struct clnt_ops {
		enum clnt_stat	(*cl_call)(__o);	/* call remote procedure */
		void		(*cl_abort)(__o);	/* abort a call */
		void		(*cl_geterr)(__o);	/* get specific error code */
		bool_t		(*cl_freeres)(__o); /* frees results */
		void		(*cl_destroy)(__o);/* destroy this structure */
 		bool_t          (*cl_control)(__o);/* the ioctl() of rpc */
	} *cl_ops;
 ...
 *	u_long vers;
 */
extern CLIENT *clntraw_create(__o);
 ...
 *	u_int recvsz;
 */
extern CLIENT *clnttcp_create(__o);
 ...
 *	u_int recvsz;
 */
extern CLIENT *clntudp_create(__o);
extern CLIENT *clntudp_bufcreate(__o);
 ...
 */
void clnt_pcreateerror(__o);
char *clnt_spcreateerror(__o);
 ...
 *			   will add to it
 */
void clnt_perror(__o);
char *clnt_sperror(__o);
 ...
 *	u_long vers;
 */
extern CLIENT *clntkudp_create(__o);
#endif
