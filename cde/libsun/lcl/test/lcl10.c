/* lcl10.c - LctNSeparatedTaggedText type send attachment sample */
/* Only attachment header or attchment body are passed to lib */
...
main(int argc, char **argv)
{
    ...
    /*** set only attachment header ***/

    /* create lclt from attachment header */
    lclt = lct_create(lcld, 
		      LctNSourceType, 
		          LctNSeparatedTaggedText, header, LctNNone,
    ...
    /*** set only attachment body ***/

    /* create lclt from attachment body */
    lclt = lct_create(lcld, 
		      LctNSourceType, 
		          LctNSeparatedTaggedText, LctNNone, body,
		      LctNSourceForm, LctNDisplayForm,
		      LctNKeepReference, LctNKeepByReference,
		      NULL);
