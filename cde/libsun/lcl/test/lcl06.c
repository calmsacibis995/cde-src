/* lcl06.c - LctNSeparatedTaggedText type display attachment sample */
...
main(int argc, char **argv)
{
    ...
    header = load_file("attach_header.iso-2022-jp-b");
    body = load_file("attach_body.iso-2022-jp");
    ...
    /* create lclt from attachment header and attachment body */
