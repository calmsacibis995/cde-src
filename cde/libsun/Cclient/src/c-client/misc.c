 ...
 */
unsigned long
find_rightmost_bit (unsigned long * valptr)
{
  ...
  while (_B_TRUE) {			/* search for bit in quarterword */
    if (value & 1) {
      break;	/* found it? */
    }
