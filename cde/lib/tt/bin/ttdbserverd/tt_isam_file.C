...
int _Tt_isam_file::addIndex (_Tt_client_isam_key_descriptor_ptr key_descriptor)
{
  iserrno = 0;
...
_Tt_client_isam_record_ptr _Tt_isam_file::getEmptyRecord ()
{
...
_Tt_client_isam_record_ptr _Tt_isam_file::readRecord (int mode)
{
  iserrno = 0;
...
int _Tt_isam_file::updateCurrentRecord (const _Tt_client_isam_record_ptr &record)
{
  iserrno = 0;
...
int
_Tt_isam_file::updateRecord (long recnum, const _Tt_client_isam_record_ptr &record)
{
  iserrno = 0;
...
int _Tt_isam_file::writeRecord (const _Tt_client_isam_record_ptr &record)
{
  iserrno = 0;
...
void _Tt_isam_file::getISAMFileInfo ()
{
  ...
  if (!results) {
    ...
    for (int i=1; i <= num_keys; i++) {
      ...
      _Tt_client_isam_key_descriptor_ptr key_descriptor_ptr =
