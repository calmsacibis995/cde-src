...
{
	// XXX - This  should be  incremented somewhere to it would
	// be useful when printing trace output.  See "match()" below.
	_timestamp = 0;
}
...
match(const _Tt_s_message &msg, const _Tt_msg_trace &trace) const
{
	...
	trace.incr_indent();
	// Until _timestamp is set to something other than 0
	// this isn't  useful.
