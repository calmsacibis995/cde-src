...
/*%%  $XConsortium: tt_port.h /main/cde1_maint/2 1995/10/04 13:39:00 gtsang $ 			 				 */
...
int	_tt_setdtablesize(int limit);
...
int	_ttsystem(const char *s);
CLIENT * _tt_clnt_create_timed(const char *, const u_long,
