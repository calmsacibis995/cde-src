...
static void _unlink_datfile(char *);
static void _unlink_indfile(char *);
static void _unlink_varfile(char *);
static int _amerase(Bytearray *, struct errcode *);
    ...
    char		*isfname;
{
	...
	_isfatal_error("iserase() cannot find FAB", (char *) 0);
