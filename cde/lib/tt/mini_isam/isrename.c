...
static void _rename_datfile(char *, char *);

static int _amrename(Bytearray *, char *, struct errcode *);

static void _rename_indfile(char *, char *);

static void _rename_varfile(char *, char *);
    ...
    char		*oldname, *newname;
{
	...
	_isfatal_error("isrename() cannot find FAB", (char *) 0);
