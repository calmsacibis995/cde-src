 ...
 * Motif Release 1.2.5
*/
/*   $XConsortium: XmStrDefs.h /main/cde1_maint/2 1995/08/18 19:36:43 drk $ */
/*
...
#ifdef XM_STRINGS_1_2_2_STATE
/* CR 10079 No revision of 1.2 is allowed to increase the size of data that is copied
 * from the SVR4 shared library to the space reserved by the application in bss.
 * Thus we restrict the size and references to _XmStrings[].
 * This will guarantee backward compatibility with applications
 * built with previous versions of the shared library.
 * Old a.out will still run (without data corruption) when the new shared
 * library is installed.
 * If the _XmStringsl[] is allowed to increase, the run-time linker would
 * copy more data than the application has reserved space for in bss.
 */
#define XmCTopItemPosition "TopItemPosition"
#define XmNtopItemPosition "topItemPosition"
#define XmRTopItemPosition "TopItemPosition"
