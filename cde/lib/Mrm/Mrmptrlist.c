...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmptrlist.c,v $ $Revision: 1.6 $ $Date: 94/04/19 07:49:24 $"
#endif
#endif
...
if ( newstg == NULL )
    return Urm__UT_Error
        ("UrmPlistAppendString", _MrmMsg_0049,
        NULL, NULL, MrmFAILURE) ;
