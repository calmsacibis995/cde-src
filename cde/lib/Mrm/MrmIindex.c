...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: MrmIindex.c,v $ $Revision: 1.5 $ $Date: 94/04/19 07:46:45 $"
#endif
#endif
	...
	*data_entry = noderec->index[entndx].data.pointer ;
    ...
    default:
        return Urm__UT_Error
            ("Idb__INX_ReturnItem", _MrmMsg_0010,
...
if ( ! Idb__INX_ValidRecord(*buffer_return) )
    return Urm__UT_Error
        ("Idb__INX_FindIndex", _MrmMsg_0010,
        file_id, NULL, MrmBAD_RECORD) ;
...
switch ( buftyp )
    ...
    default:
        return Urm__UT_Error
            ("Idb__INX_SearchIndex", _MrmMsg_0010,
            file_id, NULL, MrmBAD_RECORD) ;
    }
...
switch ( order )
    ...
    default:
        return Urm__UT_Error
            ("Idb__INX_GetBTreeRecord", _MrmMsg_0010,
 ...
 */
    ...
    default:
        return Urm__UT_Error
            ("Idb__INX_FindResources", _MrmMsg_0010,
            file_id, NULL, MrmBAD_RECORD) ;
    }
