...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmwcrwr.c,v $ $Revision: 1.6 $ $Date: 94/09/29 08:18:27 $"
#endif
#endif
...
if ( nargs > RGMListSizeMax )
    return Urm__UT_Error
        ("UrmCWRInitArgList", _MrmMsg_0092,
...
if ( tag < UilMrmMinValidCode )
    return Urm__UT_Error
        ("UrmCWRSetCompressedArgTag", _MrmMsg_0093,
...
/* ??relocate pointers to offsets?? */
    ...
    default:
        return Urm__UT_Error
            ("UrmCWRSetArgValue", _MrmMsg_0094,
...
if ( num_stg > RGMListSizeMax )
    return Urm__UT_Error
        ("DwUrmCWRSetArgChar8Vec", _MrmMsg_0095,
...
if ( num_cstg > RGMListSizeMax )
    return Urm__UT_Error
        ("DwUrmCWRSetArgCStringVec", _MrmMsg_0095,
        NULL, context_id, MrmVEC_TOO_BIG) ;
...
if ( nitems > RGMListSizeMax )
    return Urm__UT_Error
        ("UrmCWRSetArgCallback", _MrmMsg_0109,
        NULL, context_id, MrmTOO_MANY) ;
...
if ( strlen(routine) <= 0 )
    return Urm__UT_Error
        ("UrmCWRSetCallbackItem", _MrmMsg_0096,
...
switch ( type )
    ...
    case MrmRtypeChar8Vector:
        return Urm__UT_Error
            ("UrmCWRSetCallbackItem", _MrmMsg_0097,
            NULL, context_id, MrmBAD_ARG_TYPE) ;
    case MrmRtypeCString:
        result = UrmCWR__AppendCString
    ...
    case MrmRtypeCStringVector:
        return Urm__UT_Error
            ("UrmCWRSetCallbackItem", _MrmMsg_0098,
            NULL, context_id, MrmBAD_ARG_TYPE) ;
    case MrmRtypeFloat:
        result = UrmCWR__GuaranteeSpace
            (context_id, sizeof(double), &offset, (char **)&dblptr) ;
    ...
    default:
        return Urm__UT_Error
            ("UrmCWRSetCallbackItem", _MrmMsg_0094,
            NULL, context_id, MrmBAD_ARG_TYPE) ;
    }
...
if ( strlen(routine) <= 0 )
    return Urm__UT_Error
        ("UrmCWRSetCallbackItemRes", _MrmMsg_0096,
        NULL, context_id, MrmNULL_ROUTINE) ;
...
if ( nchildren > RGMListSizeMax )
    return Urm__UT_Error
        ("UrmCWRInitChildren", _MrmMsg_0099,
        NULL, context_id, MrmTOO_MANY) ;
...
if ( nitems > RGMListSizeMax )
    return Urm__UT_Error
        ("UrmCWRSetCreationCallback", _MrmMsg_0109,
        NULL, context_id, MrmTOO_MANY) ;
...
if ( ! UrmWRValid(widgetrec) )
    return Urm__UT_Error ("UrmCWR__GuaranteeSpace", _MrmMsg_0026,
...
switch ( key_type )
    ...
    case URMrIndex:
        if ( strlen(index) <= 0 )
            return Urm__UT_Error
                ("UrmCWR__AppendResource", _MrmMsg_0102,
                NULL, context_id, MrmNULL_INDEX) ;
    ...
    default:
        return Urm__UT_Error
            ("UrmCWR__AppendResource", _MrmMsg_0103,
            NULL, context_id, MrmBAD_KEY_TYPE) ;
    }
...
if ( ! UrmRCValid(context_id) )
    return Urm__UT_Error (routine, _MrmMsg_0043,
        NULL, NULL, MrmBAD_CONTEXT) ;
widgetrec = (RGMWidgetRecordPtr) UrmRCBuffer(context_id) ;
if ( ! UrmWRValid(widgetrec) )
    return Urm__UT_Error (routine, _MrmMsg_0026,
...
if ( argndx >= (*descptr)->count )
    return Urm__UT_Error (routine, _MrmMsg_0104,
        NULL, context_id, MrmOUT_OF_BOUNDS) ;
...
if ( UrmWRValid(widgetrec) )
    *descptr = (RGMCallbackDescPtr) ((char *)widgetrec+descoffs) ;
    ...
    return Urm__UT_Error (routine, _MrmMsg_0105,
        NULL, context_id, MrmBAD_RECORD) ;

if ( (*descptr)->validation != URMCallbackDescriptorValid )
    return Urm__UT_Error (routine, _MrmMsg_0106,
...
if ( itemndx >= (*descptr)->count )
    return Urm__UT_Error (routine, _MrmMsg_0107,
        NULL, context_id, MrmOUT_OF_BOUNDS) ;
