...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmappl.c,v $ $Revision: 1.5 $ $Date: 94/04/19 07:47:53 $"
#endif
#endif
...
if ( hierarchy_id == NULL )
    return Urm__UT_Error
        ("MrmFetchInterfaceModule", _MrmMsg_0023,
        NULL, NULL, MrmBAD_HIERARCHY);
if ( ! MrmHierarchyValid(hierarchy_id) )
    return Urm__UT_Error
        ("MrmFetchInterfaceModule", _MrmMsg_0024,
        NULL, NULL, MrmBAD_HIERARCHY);
...
if ( ! UrmInterfaceModuleValid(modptr) )
    ...
    UrmFreeResourceContext (mod_context);
    return Urm__UT_Error
        ("MrmFetchInterfaceModule", _MrmMsg_0025,
...
if ( hierarchy_id == NULL )
    return Urm__UT_Error
        ("MrmFetchWidgetOverride", _MrmMsg_0023,
        NULL, NULL, MrmBAD_HIERARCHY);
if ( ! MrmHierarchyValid(hierarchy_id) )
    return Urm__UT_Error
        ("MrmFetchWidgetOverride", _MrmMsg_0024,
        NULL, NULL, MrmBAD_HIERARCHY);
...
if ( ! UrmWRValid(widgetrec) )
    ...
    UrmFreeResourceContext (w_context);
    return Urm__UT_Error
        ("MrmFetchWidgetOverride", _MrmMsg_0026,
...
if ( hierarchy_id == NULL )
    return Urm__UT_Error
        ("MrmFetchSetValues", _MrmMsg_0023,
        NULL, NULL, MrmBAD_HIERARCHY);
if ( ! MrmHierarchyValid(hierarchy_id) )
    return Urm__UT_Error
        ("MrmFetchSetValues", _MrmMsg_0024,
        NULL, NULL, MrmBAD_HIERARCHY);
