...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmicon.c,v $ $Revision: 1.7 $ $Date: 94/04/19 07:48:35 $"
#endif
#endif
 ...
 */
{
  ...
  *pixmap = XmGetPixmapByDepth(screen, filename, fgint, bgint, depth);
	...
	{
	    pixmap = 0;
	    sprintf (err_msg, _MrmMsg_0033, filename);
...
if ( imagep == NULL )
    return Urm__UT_Error ("Urm__MapIconBitmap", _MrmMsg_0034,
...
if ( *pixmap == (Pixmap)0)
    {
    XFree((char*)imagep);
    return Urm__UT_Error ("Urm__MapIconBitmap", _MrmMsg_0035,
			  NULL, NULL, MrmFAILURE);
    }
...
gc = XCreateGC (display, 
		...
		&gcValues);
if ( gc == NULL )
    return Urm__UT_Error ("Urm__MapIconBitmap", _MrmMsg_0036,
			  NULL, NULL, MrmFAILURE);
...
if ( imagep == NULL )
    return Urm__UT_Error ("Urm__MapIconBitmapDepth1", _MrmMsg_0034,
			  NULL, NULL, MrmFAILURE);
...
if ( *pixmap == (Pixmap)0)
    {
    XFree((char*)imagep);
    return Urm__UT_Error ("Urm__MapIconBitmapDepth1", _MrmMsg_0035,
			  NULL, NULL, MrmFAILURE);
    }
...
if ( gc == NULL )
    return Urm__UT_Error ("Urm__MapIconBitmapDepth1", _MrmMsg_0036,
			  NULL, NULL, MrmFAILURE);
...
if ( imagep == NULL )
    return Urm__UT_Error ("Urm__MapIconReplace", _MrmMsg_0034,
			  NULL, NULL, MrmFAILURE);
...
if ( *pixmap == (Pixmap)0)
    {
    XFree((char*)imagep);
    return Urm__UT_Error ("Urm__MapIconReplace", _MrmMsg_0035,
			  NULL, NULL, MrmFAILURE);
    }
...
gc = XCreateGC (display, 
		...
		&gcValues);
if ( gc == NULL )
    return Urm__UT_Error ("Urm__MapIconReplace", _MrmMsg_0036,
			  NULL, NULL, MrmFAILURE);
...
if (alloc_pixmap == NULL)
  return Urm__UT_Error ("Urm__MapIconAllocate", _MrmMsg_0037,
			NULL, NULL, MrmFAILURE);
srclinebyt = (iconwid * srcpix + 7) / 8;
srcbytptr = icon->pixel_data.pdptr;
...
if ( imagep == NULL )
    {
    XtFree (alloc_pixmap);
    return Urm__UT_Error ("Urm__MapIconAllocate", _MrmMsg_0034,
			  NULL, NULL, MrmFAILURE);
    }
...
if ( *pixmap == (Pixmap)0)
    ...
    XtFree (alloc_pixmap);
    XFree((char*)imagep);
    return Urm__UT_Error ("Urm__MapIconAllocate", _MrmMsg_0035,
			  NULL, NULL, MrmFAILURE);
    }
...
if ( gc == NULL )
    {
    XtFree (alloc_pixmap);
    return Urm__UT_Error ("Urm__MapIconAllocate", _MrmMsg_0036,
			  NULL, NULL, MrmFAILURE);
    }
...

Cardinal Urm__UT_GetNamedColorPixel (display, cmap, colorptr, pixel_return, fallback)
    Display			*display;
    Colormap			cmap;
...
if ( status == 0) {
   if (fallback) { *pixel_return = fallback; 
		   return MrmPARTIAL_SUCCESS;
		}
   else return MrmFAILURE;
}
...

Cardinal Urm__UT_GetColorPixel (display, cmap, colorptr, pixel_return, fallback)
    Display			*display;
    Colormap			cmap;
    RGMColorDescPtr		colorptr;
    Pixel			*pixel_return;
