...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: Mrmtable.c,v $ $Revision: 1.5 $ $Date: 94/04/19 07:49:30 $"
#endif
#endif
/*
...
#else
(ctable, qfindcldesc, byte_swapped)
    UidCompressionTablePtr	ctable;
    Boolean			qfindcldesc;
    Boolean			byte_swapped;
#endif
...
if ( cfile->class_ctable == NULL )
	...
	("Urm__FindClassDescriptor", _MrmMsg_0050,
...
if ( cfile->resource_ctable == NULL )
    return Urm__UT_Error
	("Urm__UncompressCode", _MrmMsg_0050,
	 NULL, NULL, MrmFAILURE);
if ( code < UilMrmMinValidCode )
    return MrmFAILURE;
