...
public:
    ...
    DtVirtArray<filter *>*getItemList(){ return _list_items; };
    ...
    void setFilter(DtVirtArray<filter *> *);
    filter *getFilter(char *);
    void getFilterList(DtVirtArray<filter *> *);
    void updateForward(int);

    virtual void handleAddButtonPress(){ ListUiItem::handleAddButtonPress(); };
    virtual void handleChangeButtonPress(){ ListUiItem::handleChangeButtonPress(); };

private:
  RuleCmd *_rule;
  void update_display();
  char *format_string(struct filter *);
  DtVirtArray<filter *> *_list_items; 
  DtVirtArray<char *> *_deleted_items;
};
