...
private:
  ...
  Boolean _require_update; // Only used by aliase menus
public:
  ...
  Boolean requireUpdate() { return _require_update ; }
  void setRequireUpdate(Boolean value) { _require_update = value ; }
};
#endif
