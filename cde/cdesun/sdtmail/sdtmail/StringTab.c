...
#pragma ident "@(#)StringTab.c	1.41 10/25/96"
#endif
...
"Dtmail*Change_Char_Set.mnemonic: C",
...
"Dtmail*menubar*Mailbox.Show_Views.mnemonic: S",
"Dtmail*menubar*Mailbox.Auto-Filing_Mailboxes.mnemonic: A",
"Dtmail*menubar*Mailbox.Select_All_Messages.mnemonic: S",
...
"Dtmail*menubar*Inbox.mnemonic: I",
"Dtmail*menubar*Open_Other_Mailboxes.mnemonic: O",
"Dtmail*menubar*Copy_to_Other_Mailboxes.mnemonic: C",
"Dtmail*menubar*Move_to_Other_Mailboxes.mnemonic: M",
"Dtmail*menubar*Open_Mailbox.Sent_Mail.mnemonic:  M",
