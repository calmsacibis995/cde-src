...
#pragma ident "05/07/96 @(#)RoamInterruptibleCmd.hh	1.12"
#endif
...
class RoamInterruptibleCmd : public NoUndoCmd {
  ...
  protected:
    ...
    SdmBoolean		_done;         // Sdm_True if the task has been completed
    SdmBoolean _interrupted;	// Sdm_True if the task was interrupted
  ...
  public:
    ...
    virtual SdmBoolean  interrupted();
