...
/*
 * Variable for storing ToolTalk Message Quit callback
 */
static DtbTTMsgHandlerCB		dtb_tt_msg_quitCB = NULL;
/*
 * Variable for storing ToolTalk Message Do Command callback
 */
static DtbTTMsgHandlerCB		dtb_tt_msg_do_commandCB = NULL;
/*
 * Variable for storing ToolTalk Message Get Status callback
 */
static DtbTTMsgHandlerCB		dtb_tt_msg_get_statusCB = NULL;
/*
 * Variable for storing ToolTalk Message Pause/Resume callback
 */
