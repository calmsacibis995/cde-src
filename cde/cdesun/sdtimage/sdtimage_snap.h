 ...
 */
#ifndef _SDTIMAGE_SNAP_H_
#define _SDTIMAGE_SNAP_H_

#include <stdlib.h>
#include <X11/Intrinsic.h>
#include <nl_types.h>
#define DTB_PROJECT_CATALOG	"sdtimage_snap"
 ...
 */
int dtb_sdtimage_snap_initialize(
    int	*argc_in_out,
    char	**argv_in_out[],
    Widget	toplevel
);
