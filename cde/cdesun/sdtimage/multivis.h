...
*/
extern int mvCreatImg(int, int, int, int); 
extern int mvDepth();
extern int mvIsMultiVis();
extern int mvOnes(unsigned long); 
extern int mvShifts(unsigned long);

extern void mvInit();
extern void mvReset();
extern void mvWalkTree(Window, int, int, int, int, int, int);
extern void mvDoWindowsFrontToBack();

extern XColor *mvFindColorInColormap(int, int);
extern Colormap mvColormap();

extern unsigned char * CreateImageFromImg(ImageInfo *image);
