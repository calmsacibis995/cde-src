...
typedef enum {
    PORTRAIT,
    LANDSCAPE,
    ORIENT_NONE                 /* means user has rotated, thus
                                 * orientation becomes meaningless.
                                 */
} PSOrientType;
...
extern void             reimport_image (XilImage, int);
