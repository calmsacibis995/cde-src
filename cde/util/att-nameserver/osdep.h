#ifndef	NOIDENT
#ident	"@(#)nameserver:osdep.h	1.1"
#endif
/*
 osdep.h (C header file)
	Acc: 575775482 Wed Mar 30 20:38:02 1988
	Mod: 575322770 Fri Mar 25 14:52:50 1988
	Sta: 575778043 Wed Mar 30 21:20:43 1988
	Owner: 5815
	Group: 1985
	Permissions: 664
*/
...
/* $Header: osdep.h,v 1.2 91/12/10 15:28:46 xbuild Exp $ */
...
#if (NOFILES_MAX <= 128) /* 128 is value of MAXCLIENTS in dix layer */
#define MAXSOCKS (NOFILES_MAX - 1)
#else
#define MAXSOCKS 128
#endif
...
#define	MARKED_AS_DEAD(fd)	(-fd -5)
#define	GET_DEAD_FD(fd)	(-fd - 5)
