 ...
 */
    ...
    FUNC(_ilefsXpmAttributesSize, int, ());
    FUNC(_ilefsXpmFreeAttributes, int, (XpmAttributes * attributes));
...
#define XpmReadPixmapFile(dpy, d, file, pix, mask, att) \
    _ilefsXpmReadFileToPixmap(dpy, d, file, pix, mask, att)
#define XpmWritePixmapFile(dpy, file, pix, mask, att) \
    _ilefsXpmWriteFileFromPixmap(dpy, file, pix, mask, att)
...
#define XCreatePixmapFromData(dpy, d, data, pix, mask, att) \
    _ilefsXpmCreatePixmapFromData(dpy, d, data, pix, mask, att)
#define XCreateDataFromPixmap(dpy, data, pix, mask, att) \
    _ilefsXpmCreateDataFromPixmap(dpy, data, pix, mask, att)
