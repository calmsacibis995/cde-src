/*
 * $XConsortium: imakemdep.h /main/cde1_maint/4 1995/10/10 18:12:54 drk $
 * 
 * This file contains machine-dependent constants for the imake utility.
 * When porting imake, read each of the steps below and add in any necessary
 * definitions.  Do *not* edit ccimake.c or imake.c!
 */
/* for hp and ibm use CC -E  */
#if defined(_AIX)
#define USE_CC_E
#endif
 ...
 */
#ifdef __uxp__
#define imake_ccflags "-D__uxp__ -DSVR4"
#endif
...
#ifdef M_UNIX /* SCO */
#define imake_ccflags "-DSYSV -Dsco"
#endif
...
#define imake_ccflags "-Xa -DUSL -DSVR4"
#endif
 ...
 */
#if defined(sun) || defined(SYSV) || defined(SVR4) || defined(hcx) || defined(__WPX__)
...
#endif
#ifdef __uxp__
  /* defining SVR4 just because sun did since R5 */
#define SVR4
#define DEFAULT_CPP "/usr/ccs/lib/cpp"
#endif
...
#endif
#if defined(usl) || defined(__USLC__)
	"-Dusl",	/* Unix Systems Lab Products */
#endif
# ifdef M_UNIX
 	"-Dsco", 	/* SCO */
# endif /* M_UNIX */
