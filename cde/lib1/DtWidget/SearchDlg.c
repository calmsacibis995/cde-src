/* $XConsortium: SearchDlg.c /main/cde1_maint/2 1995/08/26 22:48:21 barstow $ */
/**********************************<+>*************************************
***************************************************************************
**
**  File:        SearchDlg.c
        ...
        DtEditorWidget pPriv)
{
    ...
    if (E_misspelledListLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       */
      tmpStr1 = XmStringCreateLtoR(MISSPELLED, XmFONTLIST_DEFAULT_TAG);
    }
    ...
    if (E_findFieldLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       * The resource has not been set so use its default value
       */
      tmpStr1 = XmStringCreateLtoR(FIND_LABEL, XmFONTLIST_DEFAULT_TAG);
    }
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNtopAttachment, XmATTACH_FORM); ac++;
    XtSetArg(al[ac], XmNtopOffset, 10); ac++;
    ...
    if (E_changeFieldLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       * The resource has not been set so use its default value
       */
      tmpStr1 = XmStringCreateLtoR(CHANGE_LABEL, XmFONTLIST_DEFAULT_TAG);
    }
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNleftAttachment, XmATTACH_FORM); ac++;
    XtSetArg(al[ac], XmNtopAttachment, XmATTACH_WIDGET); ac++;
    ...
    if (E_findButtonLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       * The resource has not been set so use its default value
       */
      tmpStr1 = XmStringCreateLtoR(FIND_BUTTON, XmFONTLIST_DEFAULT_TAG);
    }
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    ...
    if (E_changeButtonLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       * The resource has not been set so use its default value
       */
      tmpStr1 = XmStringCreateLtoR(CHANGE_BUTTON, XmFONTLIST_DEFAULT_TAG);
    }
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION); ac++;
    ...
    if (E_changeAllButtonLabel(pPriv) != (XmString) DtUNSPECIFIED) {
       ...
       * The resource has not been set so use its default value
       */
      tmpStr1 = XmStringCreateLtoR(CHNG_ALL_BUTTON, XmFONTLIST_DEFAULT_TAG);
    }
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION); ac++;
    ...
    /* Close button */
    ac = 0;
    tmpStr1 = XmStringCreateLtoR(CLOSE_BUTTON, XmFONTLIST_DEFAULT_TAG);
    XtSetArg(al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION); ac++;
    ...
    ac = 0;
    tmpStr1 = XmStringCreateLtoR(HELP_BUTTON, XmFONTLIST_DEFAULT_TAG);
    XtSetArg (al[ac], XmNlabelString, tmpStr1); ac++;
    XtSetArg(al[ac], XmNleftAttachment, XmATTACH_POSITION); ac++;
