/* $XConsortium: Editor.h /main/cde1_maint/1 1995/07/17 18:29:34 drk $ */
/*
...
#endif
#ifndef SDtNextrasMenuFilename  
#define SDtNextrasMenuFilename		"extrasMenuFilename"
#endif
#ifndef SDtCExtrasMenuFilename  
#define SDtCExtrasMenuFilename		"ExtrasMenuFilename"
#endif

/* Sun URL Awareness */
#ifndef SDtNenableUrlAwareness
#define SDtNenableUrlAwareness "enableUrlAwareness"
#endif
#ifndef SDtCEnableUrlAwareness
#define SDtCEnableUrlAwareness "EnableUrlAwareness"
#endif
...
extern void	DtEditorCreateFileMenu(
	Widget		editor,
	Widget		parent);

extern void	DtEditorCreateEditMenu(
	Widget		editor,
	Widget		parent);

extern void	DtEditorCreateFormatMenu(
	Widget		editor,
	Widget		parent);

extern void	DtEditorCreateOptionsMenu(
	Widget		editor,
	Widget		parent);

extern void	DtEditorCreateExtrasMenu(
	Widget		editor,
	Widget		parent);
