/* $XConsortium: SpinBox.c /main/cde1_maint/3 1995/10/05 09:22:27 lehors $ */
/*
 * DtWidget/SpinBox.c
 */
/*
...
XtTranslations _DtSpinBox_spin_trans;


/* Only need one timer for all widget instances */
static XtIntervalId timer;

static _DtConst char SpinBoxTranslationTable[] = "\
...
static _DtConst char SpinBoxChildTranslationTable[] = "\
...
/* #5: Label get focus */
static _DtConst char SpinBoxLabelTranslationTable[] = "\
        <Key>osfUp:             SpinBoxUp(child) \n\
        <Key>osfDown:           SpinBoxDown(child) \n\
        <Key>osfRight:          SpinBoxRight(child) \n\
        <Key>osfLeft:           SpinBoxLeft(child) \n\
...
static _DtConst char SpinBoxTextTranslationTable[] = "\
        <Key>osfUp:             SpinBoxUp(child) SpinBoxRight(child)\n\
        <Key>osfDown:           SpinBoxDown(child) SpinBoxLeft(child)\n\
";
static _DtConst char SpinBoxArrowTranslationTable[] = "\
        <Key>osfUp:             SpinBoxUp(child) \n\
        <Key>osfDown:           SpinBoxDown(child) \n\
        <Key>osfRight:          SpinBoxRight(child) \n\
        <Key>osfLeft:           SpinBoxLeft(child) \n\
 ...
 */
    ...
    _DtSpinBox_spin_trans = XtParseTranslationTable(SpinBoxTranslationTable);
...
{   /* MotifBc */
    ...
    XtOverrideTranslations((Widget)new, _DtSpinBox_spin_trans);
...
static void 
#ifdef _NO_PROTO
_SpinBoxFocusIn(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxFocusOut(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxUp(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxDown(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxRight(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxLeft(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxBeginLine(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void 
#ifdef _NO_PROTO
_SpinBoxEndLine(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void
#ifdef _NO_PROTO
_SpinBoxGetFocus(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void
#ifdef _NO_PROTO
_SpinBoxPrevTabGroup(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
static void
#ifdef _NO_PROTO
_SpinBoxNextTabGroup(spin, event, params, num_params)
DtSpinBoxWidget spin;
XEvent *event;
char **params;
Cardinal *num_params;
...
#endif
{
    ...
    if (MarginHeight(spin) < 0) {
	XtWarning(SB_MARGIN_HEIGHT);
	MarginHeight(spin) = 2;
    }
    if (MarginWidth(spin) < 0) {
	XtWarning(SB_MARGIN_WIDTH);
	MarginWidth(spin) = 2;
    }
...
static void	
#ifdef _NO_PROTO
CalculateSizes (spin, pwidth, pheight, parrow_width)
DtSpinBoxWidget spin;
Dimension *pwidth;
Dimension *pheight;
Dimension *parrow_width;
...
void
#ifdef _NO_PROTO
_DtSpinBoxGetArrowSize(w, resource_offset, value)
Widget w;
int resource_offset;
XtArgVal *value;
#else
...
Widget 
#ifdef _NO_PROTO
DtCreateSpinBox(parent, name, arglist, num_args)
Widget parent;
char *name;
Arg *arglist;
Cardinal num_args;
...
void
#ifdef _NO_PROTO
DtSpinBoxAddItem(spinw, item, pos)
Widget spinw;
XmString item;
int pos;
#else
