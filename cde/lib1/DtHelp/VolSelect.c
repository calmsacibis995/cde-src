/* $XConsortium: VolSelect.c /main/cde1_maint/1 1995/07/17 17:54:23 drk $ */
/************************************<+>*************************************
 ****************************************************************************
 **
 **   File:	VolSelect.c
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
static void CloseDialogCB(w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
static void SetSelectionCB(w, clientData, callData)
    Widget w;
    XtPointer clientData;
    XtPointer callData;
#else
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
static Widget CreateFileSelDialog(hw, parent, modalDialog, 
                   dlgTitle, in_out_list, out_struct)
...
/* XtSetArg (args[n], XmNdialogStyle, (modalDialog ? 
   ...
   labelString = XmStringCreateLtoR(((char *)_DTGETMESSAGE
                       (FUSET, 2,"Help Volumes")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
...
/* XtAddCallback(FSWIDGETS.list, XmNdefaultActionCallback, 
   ...
   labelString = XmStringCreateLtoR(((char *)_DTGETMESSAGE
                            (FUSET, 4,"Close")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);			n++;
   ...
   labelString = XmStringCreateLtoR(((char *)_DTGETMESSAGE
                            (FUSET, 5,"Help")), XmFONTLIST_DEFAULT_TAG);
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);			n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);		n++;
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
Widget _DtHelpFileListCreateSelectionDialog (hw, parent, modalDialog, 
                    dlgTitle, io_titlesFontList, in_out_list, out_widgets )
        DtHelpDialogWidget hw;
        Widget         parent;
        Boolean        modalDialog;
        char *         dlgTitle;
