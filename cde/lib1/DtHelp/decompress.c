/* $XConsortium: decompress.c /main/cde1_maint/1 1995/07/17 17:56:56 drk $ */
/* 
...
int
#ifdef _NO_PROTO
_DtHelpCeUncompressFile(infile, outfile)
  char *infile, *outfile;
#else
...
#endif /* _NO_PROTO */
{
    ...
    myInfo->fd   = inFd;
    myInfo->size = (int) statBuf.st_size;
