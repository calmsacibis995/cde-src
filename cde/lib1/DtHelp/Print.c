/* $XConsortium: Print.c /main/cde1_maint/1 1995/07/17 17:49:41 drk $ */
/************************************<+>*************************************
 ****************************************************************************
 **
 **   File:        Print.c
...
#ifdef _NO_PROTO
static
_DtHelpPrintCBRec * CreatePrintCBRec (widget, display, help, print)
   Widget			widget;
   _DtHelpDisplayWidgetStuff *	display;
   _DtHelpCommonHelpStuff *	help;
   _DtHelpPrintStuff *		print;
 ...
 ************************************************************************/
#ifdef _NO_PROTO
void _DtHelpInitPrintStuff (print)
    _DtHelpPrintStuff * print;
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
void _DtHelpFreePrintStuff (print,cleanUpKind)
    _DtHelpPrintStuff * print;
    int			cleanUpKind;
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
void _DtHelpPrintSetValues (currentPrint,newPrint,
			newDisplay,newCommonHelp)
 ...
 ************************************************************************/
#ifdef _NO_PROTO
static void ClosePrintCB (w, clientData, callData) 
    Widget    w;
    XtPointer clientData;
    XtPointer callData; 
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
static void DestroyDialogCB (w, clientData, callData) 
    Widget    w;
    XtPointer clientData;
    XtPointer callData; 
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
static void CheckCopiesCB (w, clientData, callData) 
    Widget    w;
    XtPointer clientData;
    XtPointer callData; 
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
static void CheckPrinterCB (w, clientData, callData) 
    Widget    w;
    XtPointer clientData;
    XtPointer callData; 
#else
 ...
 ************************************************************************/
#ifdef _NO_PROTO
static void StartPrintingCB (w, clientData, callData) 
    Widget    w;
    XtPointer clientData;
    XtPointer callData; 
#else
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
void _DtHelpUpdatePrintDialog(print,display,help,setDefaults)
    _DtHelpPrintStuff *       print;
    _DtHelpDisplayWidgetStuff * display;
    _DtHelpCommonHelpStuff *  help;
    Boolean                   setDefaults;
...
#endif
{
   ...
   XtGetValues (print->subject, args, 1);
   if ( XmStringCompare(curLabelString,labelString) == False )
   {
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
void _DtHelpDisplayPrintDialog(widget,print,display,help)
   Widget 		widget;
   _DtHelpPrintStuff *	print;
   _DtHelpDisplayWidgetStuff * display;
   _DtHelpCommonHelpStuff * help;
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
static void CreatePrintDialog(widget,print,display,help)
   Widget 		widget;
   _DtHelpPrintStuff *	print;
   _DtHelpDisplayWidgetStuff * display;
   _DtHelpCommonHelpStuff * help;
...
/*   XtSetValues (XtParent(printShell), args, n);*/
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 10,"Printer:"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);                     n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);               n++;
   ...
   /* create copies label */
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 11,"Copies:"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);                     n++;
   XtSetArg (args[n], XmNtopAttachment, XmATTACH_WIDGET);               n++;
   XtSetArg (args[n], XmNtopWidget,print->subject);	n++;
   ...
   *******************************************************/
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET,30,"Topics To Print"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);             n++;
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 31,"Current Topic"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);		      n++;
   print->curTopicBtn = 
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 32,"Current and Subtopics"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);		      n++;
   print->subTopicsBtn = 
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 33,"Table of Contents and Index"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);	              n++;
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 34,"Entire Volume"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);	              n++;
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 40,"Print"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);			n++;
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 41,"Cancel"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);			n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);		n++;
   ...
   labelString = XmStringCreateLocalized((char *)_DTGETMESSAGE(PRSET, 42,"Help"));
   n = 0;
   XtSetArg (args[n], XmNlabelString, labelString);			n++;
   XtSetArg (args[n], XmNleftAttachment, XmATTACH_POSITION);		n++;
 ...
 *****************************************************************************/
#ifdef _NO_PROTO
void _DtHelpPrintJob(widget, printExec, printer, paperSize, copies, 
			helpVolume, helpType, helpData, 
			printAll, printSub, printTocIndex, topicTitle)
    Widget	widget;
    char *	printExec;
    char *	printer;
    int		paperSize;
   ...
   switch (helpType)
   {
     ...
     case DtHELP_TYPE_FILE:
      ...
      default:  
         ...
         _XmWarning(widget, (char*)PrintMessage001);
         break;
   }  /* End Switch Statement */
