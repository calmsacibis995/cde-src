/* $XConsortium: HelpDialogP.h /main/cde1_maint/2 1995/08/26 22:42:20 barstow $ */
/*************************************<+>*************************************
 *****************************************************************************
 **
 **  File:   HelpDialogP.h
...
typedef struct _DtHelpDisplayWidgetStuff
{
        ...
        VolumeHandle    volumeHandle;        	/* handle of current volume */
...
{
        DtHelpDispAreaStruct *pDisplayArea;	/* Display widget handle */
...
typedef struct _DtHelpBrowserStuff 
{
        ...
        DtHelpDispAreaStruct *pTocArea;		/* Toc area handle */
