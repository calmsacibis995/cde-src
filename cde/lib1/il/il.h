/* $XConsortium: il.h /main/cde1_maint/3 1995/10/18 13:52:50 lehors $ */
/**---------------------------------------------------------------------
***	
***    file:           il.h
***
...
/* NOTE this was moved from ilxpmP.h 
 * previously on SYSV systems bcopy was a function call
 */
#if (defined(SYSV) || defined(SVR4)) && !defined(bcopy)
#define bcopy(source, dest, count) memcpy(dest, source, count)
#endif

#if !defined(_BSD) && !defined(bzero)
#ifdef SVR4
#define bzero(x,y)      memset((void *)(x),0,(y))       /* use ANSI C
version
   */
#else
