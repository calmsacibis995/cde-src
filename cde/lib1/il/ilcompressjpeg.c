/* $XConsortium: ilcompressjpeg.c /main/cde1_maint/1 1995/07/17 18:40:26 drk $ */
/**---------------------------------------------------------------------
***	
    ...
    )
{
    ...
    bcopy (streamRec.pData, pDstPlane->pPixels + dstOffset, nBytes);
    ...
    )
{
    ...
    bcopy (pImage->plane[0].pPixels + pData->compressed.srcOffset, streamRec.pDst, nBytes);
