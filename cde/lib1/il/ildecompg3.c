/* $XConsortium: ildecompg3.c /main/cde1_maint/1 1995/07/17 18:44:03 drk $ */
/**---------------------------------------------------------------------
***
...
/*	int secondRun;              no. of consecutive pixels for M(a1a2) in  Horiz mode */
    ...
    fillmasks[] = { 0, 0x80, 0xc0, 0xe0, 0xf0, 0xf8, 0xfc, 0xfe, 0xff 	};
...
)
{
    ...
    */
	...
	pPriv = (ilDecompG3G4PrivPtr) ilAddPipeElement(pipe, IL_FILTER, sizeof(ilDecompG3G4PrivRec), 0, (ilSrcElementData
	    *)NULL,
	    &dstdata, _ilDecompG3Init,_ilDecompG3Cleanup ,IL_NPF, _ilDecompG3Execute, 0);
