/* $XConsortium: ilscalesample.c /main/cde1_maint/1 1995/07/17 19:04:54 drk $ */
/**---------------------------------------------------------------------
***	
    ...
    switch  (Ncomponents) {
       ...
       case  3:
                 pPriv = (ilScaleSamplePtr) ilAddPipeElement (pipe, IL_FILTER, sizeof (ilScaleSampleRec), 0, (ilSrcElementData *)NULL,
                                                              &dstdata, ilScaleSampleInit, IL_NPF, IL_NPF, ilScaleSample3ByteExecute, 0);
                 break;
       case  1:
                 pPriv = (ilScaleSamplePtr) ilAddPipeElement (pipe, IL_FILTER, sizeof (ilScaleSampleRec), 0, (ilSrcElementData *)NULL,
                                                              &dstdata, ilScaleSampleInit, IL_NPF, IL_NPF, ilScaleSampleByteExecute, 0);
    }
