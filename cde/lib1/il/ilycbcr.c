/* $XConsortium: ilycbcr.c /main/cde1_maint/1 1995/07/17 19:09:25 drk $ */
/**---------------------------------------------------------------------
***
    ...
    )
{
    ...
    pSubPriv = (ilSubsamplePrivPtr)ilAddPipeElement (pipe, IL_FILTER,
                 ...
                 &dstData, IL_NPF, IL_NPF, IL_NPF, ilExecuteSubsample, 0);
    if (!pSubPriv)
        return FALSE;
    ...
    )
{
    ...
    *pDes = *IL_DES_RGB;
    ...
    pPriv = (ilYCbCrToRGBPrivPtr)ilAddPipeElement (pipe, IL_FILTER,
            ...
            IL_NPF, IL_NPF, destroyFunction, executeFunction, 0);
    if (!pPriv) {
    ...
    )
{
    ...
    pPriv = (ilYCbCr2DitherPrivPtr)ilAddPipeElement (pipe, IL_FILTER,
            ...
            ilYCbCr2DitherInit, IL_NPF, ilYCbCr2DitherDestroy, ilYCbCr2DitherExecute, 0);
    if (!pPriv) {
        if (pPriv->pPalette)
            IL_FREE (pPriv->pPalette);
        return FALSE;
    ...
    )
{
    ...
    *pFormat = *IL_FORMAT_3BYTE_PLANE;
    ...
    pPriv = (ilRGBToYCbCrPrivPtr)ilAddPipeElement (pipe, IL_FILTER,
            ...
            IL_NPF, IL_NPF, IL_NPF, ilExecuteRGBToYCbCr, 0);
    if (!pPriv)
        return FALSE;
