/* $XConsortium: ilupsample.c /main/cde1_maint/1 1995/07/17 19:07:07 drk $ */
/**---------------------------------------------------------------------
***	
    ...
    )
{
    ...
    pUpPriv = (ilUpFastPrivPtr)ilAddPipeElement (pipe, IL_FILTER, 
                 ...
                 &dstData, IL_NPF, IL_NPF, IL_NPF, ilExecuteFastUpsample, 0);
    if (!pUpPriv)
        return FALSE;
    *pUpPriv = upPriv;
    ...
    )
{
    ...
    pUpPriv = (ilUpsamplePrivPtr)ilAddPipeElement (pipe, IL_FILTER, 
                 ...
                 &dstData, IL_NPF, IL_NPF, IL_NPF, ilExecuteUpsample, 0);
    if (!pUpPriv)
        return FALSE;
