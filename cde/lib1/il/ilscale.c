/* $XConsortium: ilscale.c /main/cde1_maint/2 1995/10/08 21:08:59 pascale $ */
/**---------------------------------------------------------------------
***	
       ...
       switch (imdes.nSamplesPerPixel) {
            case 3:
                     pPriv = (ilScalePrivptr) ilAddPipeElement(pipe, IL_FILTER, sizeof(ilScalePriv), 0, (ilSrcElementData *) NULL,
                                                               &dstdata, ilScaleInit, IL_NPF, IL_NPF, ilScale3ByteExecute, 0);
                     break;

            case 1:  
                     if(bitonal) 
                       pPriv = (ilScalePrivptr) ilAddPipeElement(pipe, IL_FILTER, sizeof(ilScalePriv), 0, (ilSrcElementData *) NULL,
                                                                 &dstdata, ilScaleInit, IL_NPF, IL_NPF, ilScaleBitonalExecute, 0);
                     else 
                       pPriv = (ilScalePrivptr) ilAddPipeElement(pipe, IL_FILTER, sizeof(ilScalePriv), 0, (ilSrcElementData *) NULL,
                                                                 &dstdata, ilScaleInit, IL_NPF, IL_NPF, ilScaleByteExecute, 0);
       }
