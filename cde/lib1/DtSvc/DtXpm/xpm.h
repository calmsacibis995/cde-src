/* $XConsortium: xpm.h /main/cde1_maint/2 1995/08/29 17:26:32 drk $ */
/*
...
extern "C" {
    ...
    FUNC(_DtXpmCreatePixmapFromData, int, (Display * display,
					Drawable d,
					char **data,
    ...
    FUNC(_DtXpmReadFileToPixmap, int, (Display * display,
				    Drawable d,
				    char *filename,
				    Pixmap * pixmap_return,
				    Pixmap * shapemask_return,
    ...
    FUNC(_DtXpmWriteFileFromPixmap, int, (Display * display,
				       char *filename,
				       Pixmap pixmap,
				       Pixmap shapemask,
				       XpmAttributes * attributes));
    ...
    FUNC(_DtXpmWriteFileFromImage, int, (Display * display,
				      char *filename,
				      XImage * image,
				      XImage * shapeimage,
				      XpmAttributes * attributes));
...
#define XpmReadPixmapFile(dpy, d, file, pix, mask, att) \
    _DtXpmReadFileToPixmap(dpy, d, file, pix, mask, att)
#define XpmWritePixmapFile(dpy, file, pix, mask, att) \
    _DtXpmWriteFileFromPixmap(dpy, file, pix, mask, att)
...
#define XCreatePixmapFromData(dpy, d, data, pix, mask, att) \
    _DtXpmCreatePixmapFromData(dpy, d, data, pix, mask, att)
#define XCreateDataFromPixmap(dpy, data, pix, mask, att) \
    _DtXpmCreateDataFromPixmap(dpy, data, pix, mask, att)
