/*
 * File:         DbUtil.h $XConsortium: DbUtil.h /main/cde1_maint/1 1995/07/14 20:23:14 drk $
 * Language:     C
 *
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
extern DtDirPaths * _DtFindMatchingFiles();
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
extern DtDirPaths * _DtGetDatabaseDirPaths();
#else
 ...
 ****************************************************************************/
#ifdef _NO_PROTO
extern void _DtFreeDatabaseDirPaths();
#else
