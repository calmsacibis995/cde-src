/*
 * File:         spcP.h $XConsortium: spcP.h /main/cde1_maint/3 1995/10/08 22:14:41 pascale $
 * Language:     C
 *
...
/* This next macro is a memory leak, since XeFindShortHost will
   malloc the memory for the returned string.  However, this is not
   too big a deal since (1) the hostnames are small, and (2) this macro
   is only called in error routines.
*/
