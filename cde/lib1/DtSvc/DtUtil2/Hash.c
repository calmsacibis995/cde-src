/* $XConsortium: Hash.c /main/cde1_maint/1 1995/07/17 18:11:55 drk $ */
/*
...
void 
#ifdef _NO_PROTO
_DtRegisterHashEntry( tab, key, entry )
        register DtHashTable tab ;
        register DtHashKey key ;
        register DtHashEntry entry ;
#else
...
void 
#ifdef _NO_PROTO
_DtUnregisterHashEntry( tab, entry )
        register DtHashTable tab ;
        register DtHashEntry entry ;
#else
...
DtHashEntry 
#ifdef _NO_PROTO
_DtEnumerateHashTable( tab, enumFunc, clientData )
        register DtHashTable tab ;
...
DtHashTable 
#ifdef _NO_PROTO
_DtAllocHashTable( hashEntryTypes, numHashEntryTypes, keyIsString )
