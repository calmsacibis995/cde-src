/* $XConsortium: XlationSvc.c /main/cde1_maint/3 1995/10/08 17:21:33 pascale $ */
/****************************************************************************
...
#include <langinfo.h>         /* for RADIXCHAR and nl_langinfo */
...
#ifdef _NO_PROTO
char * ExpandPath (filespec)
        const char *        filespec;
#else /* $DEF$ */
char * ExpandPath (
       const char * filespec)
#endif /* $SKIP$, _NO_PROTO */
{  /* $CODE$ */
...
#ifdef _NO_PROTO
int _DtMBStrchr (s1, value, max_len, ret_ptr)
    const char * s1;
    int          value;
    int          max_len;
    const char * * ret_ptr;
...
#ifdef _NO_PROTO
int _DtMBStrrchr (s1, value, max_len, ret_ptr)
    const char *   s1;
    int            value;
    int            max_len;
    const char * * ret_ptr;
...
#ifdef _NO_PROTO
static
void ReplaceMatchallSubex(pStr, subex, matchedStr)
         char * *       pStr;
         regmatch_t *   subex;
...
#ifdef _NO_PROTO
static
void StripMetaAndReplaceEscSubex(pStr, keepEscChar, replaceValues)
         char * *       pStr;
...
#ifdef _NO_PROTO
static
void PrintDbEntry( quarks, value)
       XrmQuarkList quarks;
       XrmValue *   value;
#else    /*$DEF$*/
static
...
#ifdef _NO_PROTO
static
Boolean CheckForMatchall( srchData, matchallString, matchingString)
...
#ifdef _NO_PROTO
static
Boolean CheckSearchPlatformMatchesSpec(srchData, specPlatformQuark)
           __DtXlateSrchData * srchData; 
...
#ifdef _NO_PROTO
static
Boolean CheckSearchVerMatchesSpec(srchData, specVersionQuark)
           __DtXlateSrchData * srchData; 
...
#ifdef _NO_PROTO
static
Boolean CheckSearchOperMatchesSpec(srchData, specOperationQuark)
           __DtXlateSrchData * srchData; 
...
#ifdef _NO_PROTO
static
Boolean CheckSearchDirOpToStdMatchesSpec(srchData, specDirectionQuark)
           __DtXlateSrchData * srchData;
...
#ifdef _NO_PROTO
static
Boolean CheckSearchDirStdToOpMatchesSpec( srchData, specDirectionQuark)
           __DtXlateSrchData * srchData;
           XrmQuark          specDirectionQuark;
#else    /*$DEF$*/
static
...
#ifdef _NO_PROTO
static
Boolean CheckSearchStdValueMatchesSpec( srchData, specStdValueQuarks)
           __DtXlateSrchData * srchData; 
...
#ifdef _NO_PROTO
static
Boolean CheckSearchOpValueMatchesSpec(srchData, specOpValue)
           __DtXlateSrchData * srchData; 
...
{        /*$CODE$*/
    ...
    return False;  /* currently never reached; for safety if code chgd */
}        /*$END$*/
...
#ifdef _NO_PROTO
static
Bool FindStdToOpMatchCB( database, bindings, quarks, type, value, client_data)
...
#ifdef _NO_PROTO
static
Bool FindOpToStdMatchCB(database, bindings, quarks, type, value, client_data)
            XrmDatabase *       database;
            XrmBindingList      bindings;
            XrmQuarkList        quarks;
            XrmRepresentation * type;
...
#ifdef _NO_PROTO
static
void DoCommonSrchDataPrep(srchData,db,platform,version,operation)
      __DtXlateSrchData * srchData;
      _DtXlateDb          db;
      const char *        platform;
      const int           version;
...
#ifdef _NO_PROTO
int  _DtXlateOpenDb(databaseName, ret_db)
...
#ifdef _NO_PROTO
int  _DtXlateOpenAndMergeDbs(databaseName, io_db)
       const char *   databaseName;
       _DtXlateDb *   io_db;
#else    /*$DEF$*/
...
#ifdef _NO_PROTO
int  _DtXlateMergeDbs(io_dbToMerge,io_mergeIntoDb)
...
#ifdef _NO_PROTO
int  _DtXlateOpenAllDbs(searchPaths, databaseName, ret_db)
...
{       /*$CODE$*/
     ...
     if (dbRec->debugMode) fprintf(stderr,"_DtXlateCloseDb: %lx\n",dbRec);
...
#ifdef _NO_PROTO
int _DtXlateStdToOpValue(db,platform,version,operation,stdValue,
                           ret_opValue,ret_reserved)
       _DtXlateDb        db;
       const char *      platform;
       const int         version;
       const char *      operation;
...
#ifdef _NO_PROTO
int _DtXlateOpToStdValue(db, platform, version, operation, opValue, 
                           ret_stdValue, ret_reserved)
       _DtXlateDb        db;
       const char *      platform;
       const int         version;
       const char *      operation;
...
$SUMMARY$:
_DtXlateGetXlateEnv() recovers the identity of the application's
current platform, the version value of the application's
...
#define _STR(V) #V
#define STR(V) _STR(V)
      verNum = 100*OSMAJORVERSION + 10*OSMINORVERSION;
...
and operation-specific manner, for example using a library's
...
#ifdef _NO_PROTO
int _DtXlateGetXlateEnv(db, ret_AppExecEnvPlatform, 
                        ret_AppExecEnvVersion, ret_XlateCompiledForOSVersion)
         _DtXlateDb db;
...
{       /*$CODE$*/
   ...
   {
#if defined(sun) || defined(_AIX) || defined(USL) || defined(__uxp__) || defined(__osf__)
...
#error OSMAJORVERSION and/or OSMINORVERSION not defined
      ...
      *ret_XlateCompiledForOSVersion = 100*OSMAJORVERSION + 10*OSMINORVERSION;
